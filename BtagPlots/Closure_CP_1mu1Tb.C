...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,89.56078,1.2875,2270.049);
   pad1->SetFillColor(0);
   ...
   TH1F *Data_INC_1D_1mu_Box = new TH1F("Data_INC_1D_1mu_Box","",4, xAxis1);
   ...
   Data_INC_1D_1mu_Box->SetMinimum(89.56078);
   ...
   Data_INC_1D_2mu_Box__1->SetBinContent(1,1124.148);
   Data_INC_1D_2mu_Box__1->SetBinContent(2,997.3384);
   Data_INC_1D_2mu_Box__1->SetBinContent(3,579.0271);
   Data_INC_1D_2mu_Box__1->SetBinContent(4,729.8065);
   Data_INC_1D_2mu_Box__1->SetBinError(1,206.0846);
   Data_INC_1D_2mu_Box__1->SetBinError(2,230.3592);
   Data_INC_1D_2mu_Box__1->SetBinError(3,182.6825);
   Data_INC_1D_2mu_Box__1->SetBinError(4,282.0026);
   Data_INC_1D_2mu_Box__1->SetEntries(265.9769);
   ...
   h2clone__2->SetBinContent(1,1124.148);
   h2clone__2->SetBinContent(2,997.3384);
   h2clone__2->SetBinContent(3,579.0271);
   h2clone__2->SetBinContent(4,729.8065);
   h2clone__2->SetBinError(1,206.0846);
   h2clone__2->SetBinError(2,230.3592);
   h2clone__2->SetBinError(3,182.6825);
   h2clone__2->SetBinError(4,282.0026);
   h2clone__2->SetEntries(265.9769);
   ...
   TH1F *Data_INC_1D_1mu_Box = new TH1F("Data_INC_1D_1mu_Box","",4, xAxis4);
   Data_INC_1D_1mu_Box->SetBinContent(1,1026);
   Data_INC_1D_1mu_Box->SetBinContent(2,961);
   Data_INC_1D_1mu_Box->SetBinContent(3,624);
   Data_INC_1D_1mu_Box->SetBinContent(4,342);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9126909);
   RATIO->SetBinContent(2,0.9635646);
   RATIO->SetBinContent(3,1.07767);
   RATIO->SetBinContent(4,0.4686174);
   RATIO->SetBinError(1,0.02849378);
   RATIO->SetBinError(2,0.03108273);
   RATIO->SetBinError(3,0.04314132);
   RATIO->SetBinError(4,0.02533993);
   RATIO->SetMinimum(0);
   ...
   RATIO2__3->SetBinError(1,0.1833251);
   RATIO2__3->SetBinError(2,0.2309739);
   RATIO2__3->SetBinError(3,0.315499);
   RATIO2__3->SetBinError(4,0.3864073);
   ...
   ratio2clone__4->SetBinError(1,0.1833251);
   ratio2clone__4->SetBinError(2,0.2309739);
   ratio2clone__4->SetBinError(3,0.315499);
   ratio2clone__4->SetBinError(4,0.3864073);
