...
//=========  (Mon Jul 21 20:35:47 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,0.1,1.2875,206.6556);
   pad1->SetFillColor(0);
   ...
   pad1->SetFrameBorderMode(0);
   Double_t xAxis9[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   
   TH1F *Data_INC_1D_1mu_Box = new TH1F("Data_INC_1D_1mu_Box","",6, xAxis9);
   Data_INC_1D_1mu_Box->SetBinContent(1,93);
   Data_INC_1D_1mu_Box->SetBinContent(2,94);
   Data_INC_1D_1mu_Box->SetBinContent(3,38);
   Data_INC_1D_1mu_Box->SetBinContent(4,34);
   Data_INC_1D_1mu_Box->SetBinContent(5,36);
   Data_INC_1D_1mu_Box->SetBinContent(6,13);
   Data_INC_1D_1mu_Box->SetBinError(1,9.643651);
   Data_INC_1D_1mu_Box->SetBinError(2,9.69536);
   Data_INC_1D_1mu_Box->SetBinError(3,6.164414);
   Data_INC_1D_1mu_Box->SetBinError(4,5.830952);
   Data_INC_1D_1mu_Box->SetBinError(5,6);
   Data_INC_1D_1mu_Box->SetBinError(6,3.605551);
   Data_INC_1D_1mu_Box->SetMinimum(0.1);
   Data_INC_1D_1mu_Box->SetMaximum(186);
   Data_INC_1D_1mu_Box->SetEntries(308);
   ...
   Data_INC_1D_1mu_Box->GetXaxis()->SetRange(1,6);
   ...
   Double_t xAxis10[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   
   TH1F *Data_INC_1D_2mu_Box__5 = new TH1F("Data_INC_1D_2mu_Box__5","",6, xAxis10);
   Data_INC_1D_2mu_Box__5->SetBinContent(1,108.3988);
   Data_INC_1D_2mu_Box__5->SetBinContent(2,76.0934);
   Data_INC_1D_2mu_Box__5->SetBinContent(3,29.20938);
   Data_INC_1D_2mu_Box__5->SetBinContent(4,33.23827);
   Data_INC_1D_2mu_Box__5->SetBinContent(5,9.220503);
   Data_INC_1D_2mu_Box__5->SetBinContent(6,4.403026);
   Data_INC_1D_2mu_Box__5->SetBinError(1,35.90434);
   Data_INC_1D_2mu_Box__5->SetBinError(2,34.48089);
   Data_INC_1D_2mu_Box__5->SetBinError(3,22.85944);
   Data_INC_1D_2mu_Box__5->SetBinError(4,13.98712);
   Data_INC_1D_2mu_Box__5->SetBinError(5,29.18346);
   Data_INC_1D_2mu_Box__5->SetBinError(6,12.90228);
   Data_INC_1D_2mu_Box__5->SetEntries(137.8525);
   ...
   Data_INC_1D_2mu_Box__5->GetXaxis()->SetRange(1,6);
   ...
   Double_t xAxis11[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   
   TH1F *h2clone__6 = new TH1F("h2clone__6","Data_INC_1D_2mu_Box",6, xAxis11);
   h2clone__6->SetBinContent(1,108.3988);
   h2clone__6->SetBinContent(2,76.0934);
   h2clone__6->SetBinContent(3,29.20938);
   h2clone__6->SetBinContent(4,33.23827);
   h2clone__6->SetBinContent(5,9.220503);
   h2clone__6->SetBinContent(6,4.403026);
   h2clone__6->SetBinError(1,35.90434);
   h2clone__6->SetBinError(2,34.48089);
   h2clone__6->SetBinError(3,22.85944);
   h2clone__6->SetBinError(4,13.98712);
   h2clone__6->SetBinError(5,29.18346);
   h2clone__6->SetBinError(6,12.90228);
   h2clone__6->SetEntries(137.8525);
   ...
   Double_t xAxis12[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   
   TH1F *Data_INC_1D_1mu_Box = new TH1F("Data_INC_1D_1mu_Box","",6, xAxis12);
   Data_INC_1D_1mu_Box->SetBinContent(1,93);
   Data_INC_1D_1mu_Box->SetBinContent(2,94);
   Data_INC_1D_1mu_Box->SetBinContent(3,38);
   Data_INC_1D_1mu_Box->SetBinContent(4,34);
   ...
   entry=leg->AddEntry("Data_INC_1D_2mu_Box","R^{2} BKg Pred 1#mu","lf");
...
// ------------>Primitives in pad: pad2
   ...
   Double_t xAxis13[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   
   TH1F *RATIO = new TH1F("RATIO","",6, xAxis13);
   RATIO->SetBinContent(1,0.8579435);
   RATIO->SetBinContent(2,1.235324);
   RATIO->SetBinContent(3,1.300952);
   RATIO->SetBinContent(4,1.022917);
   RATIO->SetBinContent(5,3.904342);
   RATIO->SetBinContent(6,2.952515);
   RATIO->SetBinError(1,0.08896459);
   RATIO->SetBinError(2,0.1274139);
   RATIO->SetBinError(3,0.2110422);
   RATIO->SetBinError(4,0.1754289);
   RATIO->SetBinError(5,0.6507237);
   RATIO->SetBinError(6,0.8188803);
   RATIO->SetMinimum(0);
   ...
   RATIO->Draw("pe");
   Double_t xAxis14[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   ...
   RATIO2__7->SetBinError(1,0.3312247);
   RATIO2__7->SetBinError(2,0.4531391);
   RATIO2__7->SetBinError(3,0.7826059);
   RATIO2__7->SetBinError(4,0.4208137);
   RATIO2__7->SetBinError(5,3.165062);
   RATIO2__7->SetBinError(6,2.93032);
   RATIO2__7->SetMinimum(0);
   RATIO2__7->SetMaximum(6.05);
   ...
   Double_t xAxis15[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
   ...
   ratio2clone__8->SetBinError(1,0.3312247);
   ratio2clone__8->SetBinError(2,0.4531391);
   ratio2clone__8->SetBinError(3,0.7826059);
   ratio2clone__8->SetBinError(4,0.4208137);
   ratio2clone__8->SetBinError(5,3.165062);
   ratio2clone__8->SetBinError(6,2.93032);
   ratio2clone__8->SetMinimum(0);
   ratio2clone__8->SetMaximum(6.05);
   ...
   Double_t xAxis16[7] = {0.5, 0.57, 0.65, 0.73, 0.81, 0.91, 1.2}; 
