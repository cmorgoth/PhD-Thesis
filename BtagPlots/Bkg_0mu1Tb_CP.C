...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,59.53757,1.2875,2140.051);
   pad1->SetFillColor(0);
   ...
   Data_INC_1D_0mu_Box->SetMinimum(59.53757);
   ...
   Data_INC_1D_2mu_Box__1->SetBinContent(1,1040.854);
   Data_INC_1D_2mu_Box__1->SetBinContent(2,801.7749);
   Data_INC_1D_2mu_Box__1->SetBinContent(3,467.3979);
   Data_INC_1D_2mu_Box__1->SetBinContent(4,421.6049);
   Data_INC_1D_2mu_Box__1->SetBinError(1,147.4771);
   Data_INC_1D_2mu_Box__1->SetBinError(2,151.5834);
   Data_INC_1D_2mu_Box__1->SetBinError(3,104.2072);
   Data_INC_1D_2mu_Box__1->SetBinError(4,123.9171);
   Data_INC_1D_2mu_Box__1->SetEntries(363.3062);
   ...
   h2clone__2->SetBinContent(1,1040.854);
   h2clone__2->SetBinContent(2,801.7749);
   h2clone__2->SetBinContent(3,467.3979);
   h2clone__2->SetBinContent(4,421.6049);
   h2clone__2->SetBinError(1,147.4771);
   h2clone__2->SetBinError(2,151.5834);
   h2clone__2->SetBinError(3,104.2072);
   h2clone__2->SetBinError(4,123.9171);
   h2clone__2->SetEntries(363.3062);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9280837);
   RATIO->SetBinContent(2,1.159927);
   RATIO->SetBinContent(3,1.136077);
   RATIO->SetBinContent(4,0.6641288);
   RATIO->SetBinError(1,0.0298606);
   RATIO->SetBinError(2,0.03803549);
   RATIO->SetBinError(3,0.04930154);
   RATIO->SetBinError(4,0.03968929);
   RATIO->SetMinimum(0);
   ...
   RATIO2__3->SetBinError(1,0.1416885);
   RATIO2__3->SetBinError(2,0.1890598);
   RATIO2__3->SetBinError(3,0.2229518);
   RATIO2__3->SetBinError(4,0.2939176);
   ...
   ratio2clone__4->SetBinError(1,0.1416885);
   ratio2clone__4->SetBinError(2,0.1890598);
   ratio2clone__4->SetBinError(3,0.2229518);
   ratio2clone__4->SetBinError(4,0.2939176);
