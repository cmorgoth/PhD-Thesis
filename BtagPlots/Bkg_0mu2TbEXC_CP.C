...
//=========  (Thu Sep 11 16:58:41 2014) by ROOT version5.34/20
  ...
  Data_INC_1D_0mu_Box->SetYTitle("Events / bin");
   ...
   Data_INC_1D_0mu_Box->GetYaxis()->SetTitleOffset(0.65);
   ...
   Data_INC_1D_2mu_Box__1->SetBinContent(1,135.4558);
   Data_INC_1D_2mu_Box__1->SetBinContent(2,80.84422);
   Data_INC_1D_2mu_Box__1->SetBinContent(3,36.09473);
   Data_INC_1D_2mu_Box__1->SetBinContent(4,18.88778);
   Data_INC_1D_2mu_Box__1->SetBinError(1,22.76866);
   Data_INC_1D_2mu_Box__1->SetBinError(2,17.47893);
   Data_INC_1D_2mu_Box__1->SetBinError(3,7.436045);
   Data_INC_1D_2mu_Box__1->SetBinError(4,4.712214);
   Data_INC_1D_2mu_Box__1->SetEntries(186.1229);
   ...
   h2clone__2->SetBinContent(1,135.4558);
   h2clone__2->SetBinContent(2,80.84422);
   h2clone__2->SetBinContent(3,36.09473);
   h2clone__2->SetBinContent(4,18.88778);
   h2clone__2->SetBinError(1,22.76866);
   h2clone__2->SetBinError(2,17.47893);
   h2clone__2->SetBinError(3,7.436045);
   h2clone__2->SetBinError(4,4.712214);
   h2clone__2->SetEntries(186.1229);
   ...
   Data_INC_1D_0mu_Box_copy->SetBinContent(1,122);
   Data_INC_1D_0mu_Box_copy->SetBinContent(2,80);
   Data_INC_1D_0mu_Box_copy->SetBinContent(3,31);
   Data_INC_1D_0mu_Box_copy->SetBinContent(4,14);
   Data_INC_1D_0mu_Box_copy->SetBinError(1,11.04536);
   Data_INC_1D_0mu_Box_copy->SetBinError(2,8.944272);
   Data_INC_1D_0mu_Box_copy->SetBinError(3,5.567764);
   Data_INC_1D_0mu_Box_copy->SetBinError(4,3.741657);
   Data_INC_1D_0mu_Box_copy->SetMinimum(2.835114);
   Data_INC_1D_0mu_Box_copy->SetMaximum(244);
   Data_INC_1D_0mu_Box_copy->SetEntries(247);
  ...
  leg->SetFillStyle(1001);
   ...
   latex.DrawLatex(0.43,0.79,"0#mubb search sample");
  ...
  pad2 = new TPad("pad2", "pad2",0,0.005,1,0.265);
   ...
   RATIO2__3->SetBinError(1,0.1680891);
   RATIO2__3->SetBinError(2,0.2162051);
   RATIO2__3->SetBinError(3,0.2060147);
   RATIO2__3->SetBinError(4,0.2494847);
   ...
   ratio2clone__4->SetBinError(1,0.1680891);
   ratio2clone__4->SetBinError(2,0.2162051);
   ratio2clone__4->SetBinError(3,0.2060147);
   ratio2clone__4->SetBinError(4,0.2494847);
   ...
   RATIO_V2->SetBinContent(1,0.9006625);
   RATIO_V2->SetBinContent(2,0.9895574);
   RATIO_V2->SetBinContent(3,0.8588511);
   RATIO_V2->SetBinContent(4,0.7412198);
   RATIO_V2->SetBinError(1,0.08154215);
   RATIO_V2->SetBinError(2,0.1106359);
   RATIO_V2->SetBinError(3,0.1542542);
   RATIO_V2->SetBinError(4,0.1980993);
