...
//=========  (Wed Sep 10 22:46:43 2014) by ROOT version5.34/20
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,0.8570816,1.2875,59.90477);
   pad1->SetFillColor(0);
   ...
   Data_INC_1D_2mu_Box->SetMinimum(0.8570816);
   ...
   TH1F *TT_INC_1D_2mu_Box__1 = new TH1F("TT_INC_1D_2mu_Box__1","",4, xAxis2);
   TT_INC_1D_2mu_Box__1->SetBinContent(1,25.27292);
   TT_INC_1D_2mu_Box__1->SetBinContent(2,19.60651);
   TT_INC_1D_2mu_Box__1->SetBinContent(3,11.09309);
   TT_INC_1D_2mu_Box__1->SetBinContent(4,4.810555);
   TT_INC_1D_2mu_Box__1->SetBinError(1,1.164943);
   TT_INC_1D_2mu_Box__1->SetBinError(2,1.055625);
   TT_INC_1D_2mu_Box__1->SetBinError(3,0.8419148);
   TT_INC_1D_2mu_Box__1->SetBinError(4,0.5251472);
   TT_INC_1D_2mu_Box__1->SetEntries(1418.372);
   TT_INC_1D_2mu_Box__1->SetDirectory(0);
   TT_INC_1D_2mu_Box__1->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#ffcccc");
   TT_INC_1D_2mu_Box__1->SetFillColor(ci);

   ci = TColor::GetColor("#ffcccc");
   TT_INC_1D_2mu_Box__1->SetLineColor(ci);
   TT_INC_1D_2mu_Box__1->SetLineWidth(2);
   TT_INC_1D_2mu_Box__1->GetXaxis()->SetTitle("RSQ");
   TT_INC_1D_2mu_Box__1->GetXaxis()->SetRange(1,4);
   TT_INC_1D_2mu_Box__1->GetXaxis()->SetLabelFont(42);
   TT_INC_1D_2mu_Box__1->GetXaxis()->SetLabelSize(0.035);
   TT_INC_1D_2mu_Box__1->GetXaxis()->SetTitleSize(0.035);
   TT_INC_1D_2mu_Box__1->GetXaxis()->SetTitleFont(42);
   TT_INC_1D_2mu_Box__1->GetYaxis()->SetLabelFont(42);
   TT_INC_1D_2mu_Box__1->GetYaxis()->SetLabelSize(0.035);
   TT_INC_1D_2mu_Box__1->GetYaxis()->SetTitleSize(0.035);
   TT_INC_1D_2mu_Box__1->GetYaxis()->SetTitleFont(42);
   TT_INC_1D_2mu_Box__1->GetZaxis()->SetLabelFont(42);
   TT_INC_1D_2mu_Box__1->GetZaxis()->SetLabelSize(0.035);
   TT_INC_1D_2mu_Box__1->GetZaxis()->SetTitleSize(0.035);
   TT_INC_1D_2mu_Box__1->GetZaxis()->SetTitleFont(42);
   TT_INC_1D_2mu_Box__1->Draw("E2same");
   Double_t xAxis3[5] = {0.5, 0.6, 0.75, 0.9, 1.2}; 
   
   TH1F *h2clone__2 = new TH1F("h2clone__2","TT_INC_1D_2mu_Box",4, xAxis3);
   h2clone__2->SetBinContent(1,25.27292);
   h2clone__2->SetBinContent(2,19.60651);
   h2clone__2->SetBinContent(3,11.09309);
   h2clone__2->SetBinContent(4,4.810555);
   h2clone__2->SetBinError(1,1.164943);
   h2clone__2->SetBinError(2,1.055625);
   h2clone__2->SetBinError(3,0.8419148);
   h2clone__2->SetBinError(4,0.5251472);
   h2clone__2->SetEntries(1418.372);
   ...
   entry=leg->AddEntry("TT_INC_1D_2mu_Box","R^{2} BKg Pred 2#mu","lf");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.068337);
   RATIO->SetBinContent(2,0.8670588);
   RATIO->SetBinContent(3,0.9014617);
   RATIO->SetBinContent(4,1.247257);
   RATIO->SetBinError(1,0.2056016);
   RATIO->SetBinError(2,0.2102926);
   RATIO->SetBinError(3,0.2850672);
   RATIO->SetBinError(4,0.5091907);
   RATIO->SetMinimum(0);
   ...
   RATIO2__3->SetBinError(1,0.04609452);
   RATIO2__3->SetBinError(2,0.05384053);
   RATIO2__3->SetBinError(3,0.0758954);
   RATIO2__3->SetBinError(4,0.1091656);
   ...
   ratio2clone__4->SetBinError(1,0.04609452);
   ratio2clone__4->SetBinError(2,0.05384053);
   ratio2clone__4->SetBinError(3,0.0758954);
   ratio2clone__4->SetBinError(4,0.1091656);
