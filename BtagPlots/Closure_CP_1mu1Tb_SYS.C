...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,50.06149,1.2875,2274.438);
   pad1->SetFillColor(0);
   ...
   Data_INC_1D_1mu_Box->SetMinimum(50.06149);
   ...
   Data_INC_1D_2mu_Box__5->SetBinContent(1,1124.148);
   Data_INC_1D_2mu_Box__5->SetBinContent(2,997.3384);
   Data_INC_1D_2mu_Box__5->SetBinContent(3,579.0271);
   Data_INC_1D_2mu_Box__5->SetBinContent(4,729.8065);
   Data_INC_1D_2mu_Box__5->SetBinError(1,228.263);
   Data_INC_1D_2mu_Box__5->SetBinError(2,233.2077);
   Data_INC_1D_2mu_Box__5->SetBinError(3,188.1368);
   Data_INC_1D_2mu_Box__5->SetBinError(4,479.499);
   Data_INC_1D_2mu_Box__5->SetEntries(265.9769);
   ...
   h2clone__6->SetBinContent(1,1124.148);
   h2clone__6->SetBinContent(2,997.3384);
   h2clone__6->SetBinContent(3,579.0271);
   h2clone__6->SetBinContent(4,729.8065);
   h2clone__6->SetBinError(1,228.263);
   h2clone__6->SetBinError(2,233.2077);
   h2clone__6->SetBinError(3,188.1368);
   h2clone__6->SetBinError(4,479.499);
   h2clone__6->SetEntries(265.9769);
   ...
   TH1F *Data_INC_1D_1mu_Box = new TH1F("Data_INC_1D_1mu_Box","",4, xAxis12);
   Data_INC_1D_1mu_Box->SetBinContent(1,1026);
   Data_INC_1D_1mu_Box->SetBinContent(2,961);
   Data_INC_1D_1mu_Box->SetBinContent(3,624);
   Data_INC_1D_1mu_Box->SetBinContent(4,342);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO2__7->SetBinError(1,0.2030541);
   RATIO2__7->SetBinError(2,0.2338301);
   RATIO2__7->SetBinError(3,0.3249188);
   RATIO2__7->SetBinError(4,0.6570222);
   ...
   ratio2clone__8->SetBinError(1,0.2030541);
   ratio2clone__8->SetBinError(2,0.2338301);
   ratio2clone__8->SetBinError(3,0.3249188);
   ratio2clone__8->SetBinError(4,0.6570222);
