...
// ------------>Primitives in pad: pad1
   ...
   PT_1D_J1_5mu_BoxMC->SetBinContent(1,186.6408);
   PT_1D_J1_5mu_BoxMC->SetBinContent(2,105.1297);
   PT_1D_J1_5mu_BoxMC->SetBinContent(3,37.91507);
   PT_1D_J1_5mu_BoxMC->SetBinContent(4,16.93708);
   PT_1D_J1_5mu_BoxMC->SetBinContent(5,7.461105);
   PT_1D_J1_5mu_BoxMC->SetBinContent(6,3.714425);
   PT_1D_J1_5mu_BoxMC->SetBinContent(7,1.413696);
   PT_1D_J1_5mu_BoxMC->SetBinContent(8,0.6143621);
   PT_1D_J1_5mu_BoxMC->SetBinContent(9,0.2279484);
   PT_1D_J1_5mu_BoxMC->SetBinContent(10,0.0449666);
   PT_1D_J1_5mu_BoxMC->SetBinContent(11,0.0711049);
   PT_1D_J1_5mu_BoxMC->SetBinContent(16,0.02674043);
   PT_1D_J1_5mu_BoxMC->SetEntries(9297);
   ...
   TH1F *PT_1D_J1_5mu_BoxMC = new TH1F("PT_1D_J1_5mu_BoxMC","",20,80,1500);
   PT_1D_J1_5mu_BoxMC->SetBinContent(1,1.495322);
   PT_1D_J1_5mu_BoxMC->SetBinContent(2,0.9696271);
   PT_1D_J1_5mu_BoxMC->SetBinContent(3,0.04688469);
   PT_1D_J1_5mu_BoxMC->SetBinContent(5,0.02868865);
   PT_1D_J1_5mu_BoxMC->SetBinContent(6,0.04378924);
   PT_1D_J1_5mu_BoxMC->SetEntries(61);
   PT_1D_J1_5mu_BoxMC->SetStats(0);
   ...
   TH1F *PT_1D_J1_5mu_BoxMC = new TH1F("PT_1D_J1_5mu_BoxMC","",20,80,1500);
   PT_1D_J1_5mu_BoxMC->SetBinContent(2,0.2510639);
   PT_1D_J1_5mu_BoxMC->SetBinContent(3,0.2664947);
   PT_1D_J1_5mu_BoxMC->SetEntries(3);
   PT_1D_J1_5mu_BoxMC->SetStats(0);
   ...
   PT_1D_J1_Data_2mu_Box->SetBinContent(1,185);
   PT_1D_J1_Data_2mu_Box->SetBinContent(2,85);
   PT_1D_J1_Data_2mu_Box->SetBinContent(3,31);
   PT_1D_J1_Data_2mu_Box->SetBinContent(4,14);
   PT_1D_J1_Data_2mu_Box->SetBinContent(5,4);
   PT_1D_J1_Data_2mu_Box->SetBinContent(6,3);
   PT_1D_J1_Data_2mu_Box->SetBinError(1,13.60147);
   PT_1D_J1_Data_2mu_Box->SetBinError(2,9.219544);
   PT_1D_J1_Data_2mu_Box->SetBinError(3,5.567764);
   PT_1D_J1_Data_2mu_Box->SetBinError(4,3.741657);
   PT_1D_J1_Data_2mu_Box->SetBinError(5,2);
   PT_1D_J1_Data_2mu_Box->SetBinError(6,1.732051);
   PT_1D_J1_Data_2mu_Box->SetEntries(322);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9833307);
   RATIO->SetBinContent(2,0.7992452);
   RATIO->SetBinContent(3,0.8109144);
   RATIO->SetBinContent(4,0.8265888);
   RATIO->SetBinContent(5,0.5340601);
   RATIO->SetBinContent(6,0.7982515);
   RATIO->SetBinError(1,0.07463018);
   RATIO->SetBinError(2,0.08857564);
   RATIO->SetBinError(3,0.1476963);
   RATIO->SetBinError(4,0.2230303);
   RATIO->SetBinError(5,0.2686276);
   RATIO->SetBinError(6,0.4651686);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(60.46675);
   RATIO->SetStats(0);
