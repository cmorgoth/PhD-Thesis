...
// ------------>Primitives in pad: pad1
   ...
   PT_1D_J2_5mu_BoxMC->SetBinContent(1,333.6392);
   PT_1D_J2_5mu_BoxMC->SetBinContent(2,22.65154);
   PT_1D_J2_5mu_BoxMC->SetBinContent(3,3.381635);
   PT_1D_J2_5mu_BoxMC->SetBinContent(4,0.4958552);
   PT_1D_J2_5mu_BoxMC->SetBinContent(5,0.01323152);
   PT_1D_J2_5mu_BoxMC->SetBinContent(6,0.01393034);
   PT_1D_J2_5mu_BoxMC->SetEntries(9297);
   ...
   TH1F *PT_1D_J2_5mu_BoxMC = new TH1F("PT_1D_J2_5mu_BoxMC","",20,80,1500);
   PT_1D_J2_5mu_BoxMC->SetBinContent(1,2.407717);
   PT_1D_J2_5mu_BoxMC->SetBinContent(2,0.1765944);
   PT_1D_J2_5mu_BoxMC->SetEntries(61);
   PT_1D_J2_5mu_BoxMC->SetStats(0);
   ...
   TH1F *PT_1D_J2_5mu_BoxMC = new TH1F("PT_1D_J2_5mu_BoxMC","",20,80,1500);
   PT_1D_J2_5mu_BoxMC->SetBinContent(1,0.5175585);
   PT_1D_J2_5mu_BoxMC->SetEntries(3);
   PT_1D_J2_5mu_BoxMC->SetStats(0);
   ...
   PT_1D_J2_Data_2mu_Box->SetBinContent(1,304);
   PT_1D_J2_Data_2mu_Box->SetBinContent(2,14);
   PT_1D_J2_Data_2mu_Box->SetBinContent(3,3);
   PT_1D_J2_Data_2mu_Box->SetBinContent(4,1);
   PT_1D_J2_Data_2mu_Box->SetBinError(1,17.4356);
   PT_1D_J2_Data_2mu_Box->SetBinError(2,3.741657);
   PT_1D_J2_Data_2mu_Box->SetBinError(3,1.732051);
   PT_1D_J2_Data_2mu_Box->SetBinError(4,1);
   PT_1D_J2_Data_2mu_Box->SetEntries(322);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9032444);
   RATIO->SetBinContent(2,0.6132784);
   RATIO->SetBinContent(3,0.8871448);
   RATIO->SetBinContent(4,2.016718);
   RATIO->SetBinError(1,0.0531569);
   RATIO->SetBinError(2,0.1653374);
   RATIO->SetBinError(3,0.5171437);
   RATIO->SetBinError(4,2.059322);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(4.305435);
   RATIO->SetStats(0);
