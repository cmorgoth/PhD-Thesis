...
// ------------>Primitives in pad: pad1
   ...
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(1,238.6856);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(2,103.3782);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(3,16.15511);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(4,1.956834);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(6,0.02107686);
   PT_1D_m2_2mu_BoxMC_v1->SetEntries(9297);
   ...
   TH1F *PT_1D_m2_2mu_BoxMC_v1 = new TH1F("PT_1D_m2_2mu_BoxMC_v1","",20,0,1500);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(1,2.514206);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(2,0.07010496);
   PT_1D_m2_2mu_BoxMC_v1->SetEntries(61);
   PT_1D_m2_2mu_BoxMC_v1->SetStats(0);
   ...
   TH1F *PT_1D_m2_2mu_BoxMC_v1 = new TH1F("PT_1D_m2_2mu_BoxMC_v1","",20,0,1500);
   PT_1D_m2_2mu_BoxMC_v1->SetBinContent(1,0.5175585);
   PT_1D_m2_2mu_BoxMC_v1->SetEntries(3);
   PT_1D_m2_2mu_BoxMC_v1->SetStats(0);
   ...
   PT_1D_m2_Data_2mu_Box_v0->SetBinContent(1,235);
   PT_1D_m2_Data_2mu_Box_v0->SetBinContent(2,81);
   PT_1D_m2_Data_2mu_Box_v0->SetBinContent(3,5);
   PT_1D_m2_Data_2mu_Box_v0->SetBinContent(4,1);
   PT_1D_m2_Data_2mu_Box_v0->SetBinError(1,15.32971);
   PT_1D_m2_Data_2mu_Box_v0->SetBinError(2,9);
   PT_1D_m2_Data_2mu_Box_v0->SetBinError(3,2.236068);
   PT_1D_m2_Data_2mu_Box_v0->SetBinError(4,1);
   PT_1D_m2_Data_2mu_Box_v0->SetEntries(322);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9722098);
   RATIO->SetBinContent(2,0.7829998);
   RATIO->SetBinContent(3,0.3094997);
   RATIO->SetBinContent(4,0.5110295);
   RATIO->SetBinError(1,0.06524757);
   RATIO->SetBinError(2,0.08877029);
   RATIO->SetBinError(3,0.1389878);
   RATIO->SetBinError(4,0.5138499);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(22.45179);
   RATIO->SetStats(0);
