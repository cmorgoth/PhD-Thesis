...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,0.7447841,1.2875,2.007039);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_1mu_Box->SetBinContent(1,38);
   ...
   Data_cat1_1D_1mu_Box->SetBinContent(6,19);
   Data_cat1_1D_1mu_Box->SetBinContent(7,30);
   Data_cat1_1D_1mu_Box->SetBinError(1,6.164414);
   ...
   Data_cat1_1D_1mu_Box->SetBinError(6,4.358899);
   Data_cat1_1D_1mu_Box->SetBinError(7,5.477226);
   Data_cat1_1D_1mu_Box->SetMinimum(5.55628);
   Data_cat1_1D_1mu_Box->SetMaximum(76);
   Data_cat1_1D_1mu_Box->SetEntries(189);
   ...
   TH1F *TT_cat1_1D_1mu_Box__5 = new TH1F("TT_cat1_1D_1mu_Box__5","",7, xAxis10);
   TT_cat1_1D_1mu_Box__5->SetBinContent(1,44.17615);
   TT_cat1_1D_1mu_Box__5->SetBinContent(2,35.59439);
   TT_cat1_1D_1mu_Box__5->SetBinContent(3,28.46019);
   TT_cat1_1D_1mu_Box__5->SetBinContent(4,23.56931);
   TT_cat1_1D_1mu_Box__5->SetBinContent(5,16.04104);
   TT_cat1_1D_1mu_Box__5->SetBinContent(6,11.65254);
   TT_cat1_1D_1mu_Box__5->SetBinContent(7,29.50638);
   TT_cat1_1D_1mu_Box__5->SetBinError(1,6.418744);
   TT_cat1_1D_1mu_Box__5->SetBinError(2,15.48742);
   TT_cat1_1D_1mu_Box__5->SetBinError(3,6.633501);
   TT_cat1_1D_1mu_Box__5->SetBinError(4,5.747235);
   TT_cat1_1D_1mu_Box__5->SetBinError(5,5.165383);
   TT_cat1_1D_1mu_Box__5->SetBinError(6,7.412649);
   TT_cat1_1D_1mu_Box__5->SetBinError(7,1.72498);
   TT_cat1_1D_1mu_Box__5->SetEntries(3020);
   ...
   TT_cat1_1D_1mu_Box__5->GetXaxis()->SetRange(1,7);
   ...
   TH1F *h2clone__6 = new TH1F("h2clone__6","TT_cat1_1D_1mu_Box",7, xAxis11);
   h2clone__6->SetBinContent(1,44.17615);
   h2clone__6->SetBinContent(2,35.59439);
   h2clone__6->SetBinContent(3,28.46019);
   h2clone__6->SetBinContent(4,23.56931);
   h2clone__6->SetBinContent(5,16.04104);
   h2clone__6->SetBinContent(6,11.65254);
   h2clone__6->SetBinContent(7,29.50638);
   h2clone__6->SetBinError(1,6.418744);
   h2clone__6->SetBinError(2,15.48742);
   h2clone__6->SetBinError(3,6.633501);
   h2clone__6->SetBinError(4,5.747235);
   h2clone__6->SetBinError(5,5.165383);
   h2clone__6->SetBinError(6,7.412649);
   h2clone__6->SetBinError(7,1.72498);
   h2clone__6->SetEntries(3020);
   ...
   entry=leg->AddEntry("TT_cat1_1D_1mu_Box","R^{2} BKg Pred 1#mu-2b","lf");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.8601927);
   RATIO->SetBinContent(2,1.43281);
   RATIO->SetBinContent(3,0.7730095);
   RATIO->SetBinContent(4,0.763705);
   RATIO->SetBinContent(5,0.6857409);
   RATIO->SetBinContent(6,1.630546);
   RATIO->SetBinContent(7,1.016729);
   RATIO->SetBinError(1,0.1395417);
   RATIO->SetBinError(2,0.2006336);
   RATIO->SetBinError(3,0.1648062);
   RATIO->SetBinError(4,0.180007);
   RATIO->SetBinError(5,0.2067587);
   RATIO->SetBinError(6,0.3740728);
   RATIO->SetBinError(7,0.1856285);
   RATIO->SetMinimum(0);
   ...
   RATIO2__7->SetBinError(1,0.1452989);
   RATIO2__7->SetBinError(2,0.4351085);
   RATIO2__7->SetBinError(3,0.23308);
   RATIO2__7->SetBinError(4,0.243844);
   RATIO2__7->SetBinError(5,0.3220104);
   RATIO2__7->SetBinError(6,0.6361401);
   RATIO2__7->SetBinError(7,0.05846125);
   ...
   ratio2clone__8->SetBinError(1,0.1452989);
   ratio2clone__8->SetBinError(2,0.4351085);
   ratio2clone__8->SetBinError(3,0.23308);
   ratio2clone__8->SetBinError(4,0.243844);
   ratio2clone__8->SetBinError(5,0.3220104);
   ratio2clone__8->SetBinError(6,0.6361401);
   ratio2clone__8->SetBinError(7,0.05846125);
