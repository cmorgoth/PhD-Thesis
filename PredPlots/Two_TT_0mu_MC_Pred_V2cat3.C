...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,-0.02028174,1.2875,1.535822);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_0mu_Box->SetMinimum(0.9543732);
   ...
   TH1F *TT_cat3_1D_0mu_Box__17 = new TH1F("TT_cat3_1D_0mu_Box__17","",4, xAxis34);
   TT_cat3_1D_0mu_Box__17->SetBinContent(1,11.37848);
   TT_cat3_1D_0mu_Box__17->SetBinContent(2,8.497474);
   TT_cat3_1D_0mu_Box__17->SetBinContent(3,5.132638);
   TT_cat3_1D_0mu_Box__17->SetBinContent(4,5.991406);
   TT_cat3_1D_0mu_Box__17->SetBinError(1,1.188844);
   TT_cat3_1D_0mu_Box__17->SetBinError(2,1.016939);
   TT_cat3_1D_0mu_Box__17->SetBinError(3,1.076326);
   TT_cat3_1D_0mu_Box__17->SetBinError(4,1.21954);
   TT_cat3_1D_0mu_Box__17->SetEntries(571);
   ...
   TT_cat3_1D_0mu_Box__17->GetXaxis()->SetRange(1,4);
   ...
   TH1F *h2clone__18 = new TH1F("h2clone__18","TT_cat3_1D_0mu_Box",4, xAxis35);
   h2clone__18->SetBinContent(1,11.37848);
   h2clone__18->SetBinContent(2,8.497474);
   h2clone__18->SetBinContent(3,5.132638);
   h2clone__18->SetBinContent(4,5.991406);
   h2clone__18->SetBinError(1,1.188844);
   h2clone__18->SetBinError(2,1.016939);
   h2clone__18->SetBinError(3,1.076326);
   h2clone__18->SetBinError(4,1.21954);
   h2clone__18->SetEntries(571);
   ...
   entry=leg->AddEntry("TT_cat3_1D_0mu_Box","R^{2} BKg Pred 0#mu-2b","lf");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.054622);
   RATIO->SetBinContent(2,0.9414563);
   RATIO->SetBinContent(3,1.16899);
   RATIO->SetBinContent(4,0.8345286);
   RATIO->SetBinError(1,0.3044432);
   RATIO->SetBinError(2,0.3328551);
   RATIO->SetBinError(3,0.477238);
   RATIO->SetBinError(4,0.3732125);
   RATIO->SetMinimum(0);
   ...
   RATIO2__19->SetBinError(1,0.1044818);
   RATIO2__19->SetBinError(2,0.1196755);
   RATIO2__19->SetBinError(3,0.2097023);
   RATIO2__19->SetBinError(4,0.2035482);
   ...
   ratio2clone__20->SetBinError(1,0.1044818);
   ratio2clone__20->SetBinError(2,0.1196755);
   ratio2clone__20->SetBinError(3,0.2097023);
   ratio2clone__20->SetBinError(4,0.2035482);
