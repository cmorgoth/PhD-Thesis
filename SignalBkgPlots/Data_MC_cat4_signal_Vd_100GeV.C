...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal6_cat3 = new TH1F("signal6_cat3","signal6_cat3",4, xAxis59);
   signal6_cat3->SetBinContent(1,14.07437);
   signal6_cat3->SetBinContent(2,7.884356);
   signal6_cat3->SetBinContent(3,14.92806);
   signal6_cat3->SetBinContent(4,3.816783);
   signal6_cat3->SetEntries(285);
   signal6_cat3->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal6_cat3->SetLineColor(ci);
   signal6_cat3->GetXaxis()->SetLabelFont(42);
   signal6_cat3->GetXaxis()->SetLabelSize(0.035);
   signal6_cat3->GetXaxis()->SetTitleSize(0.035);
   signal6_cat3->GetXaxis()->SetTitleFont(42);
   signal6_cat3->GetYaxis()->SetLabelFont(42);
   signal6_cat3->GetYaxis()->SetLabelSize(0.035);
   signal6_cat3->GetYaxis()->SetTitleSize(0.035);
   signal6_cat3->GetYaxis()->SetTitleFont(42);
   signal6_cat3->GetZaxis()->SetLabelFont(42);
   signal6_cat3->GetZaxis()->SetLabelSize(0.035);
   signal6_cat3->GetZaxis()->SetTitleSize(0.035);
   signal6_cat3->GetZaxis()->SetTitleFont(42);
   signal6_cat3->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal6_cat3"," Vd-DM m = 100 GeV","l");
