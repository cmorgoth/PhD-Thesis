...
//=========  (Thu Sep 11 01:14:51 2014) by ROOT version5.34/20
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal6_cat1 = new TH1F("signal6_cat1","signal6_cat1",6, xAxis29);
   signal6_cat1->SetBinContent(1,24.9129);
   signal6_cat1->SetBinContent(2,19.51027);
   signal6_cat1->SetBinContent(3,26.05164);
   signal6_cat1->SetBinContent(4,21.05086);
   signal6_cat1->SetBinContent(5,22.59143);
   signal6_cat1->SetBinContent(6,24.15992);
   signal6_cat1->SetEntries(852);
   signal6_cat1->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal6_cat1->SetLineColor(ci);
   signal6_cat1->GetXaxis()->SetLabelFont(42);
   signal6_cat1->GetXaxis()->SetLabelSize(0.035);
   signal6_cat1->GetXaxis()->SetTitleSize(0.035);
   signal6_cat1->GetXaxis()->SetTitleFont(42);
   signal6_cat1->GetYaxis()->SetLabelFont(42);
   signal6_cat1->GetYaxis()->SetLabelSize(0.035);
   signal6_cat1->GetYaxis()->SetTitleSize(0.035);
   signal6_cat1->GetYaxis()->SetTitleFont(42);
   signal6_cat1->GetZaxis()->SetLabelFont(42);
   signal6_cat1->GetZaxis()->SetLabelSize(0.035);
   signal6_cat1->GetZaxis()->SetTitleSize(0.035);
   signal6_cat1->GetZaxis()->SetTitleFont(42);
   signal6_cat1->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal6_cat1"," Vd-DM m = 100 GeV","l");
