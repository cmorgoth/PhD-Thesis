...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal7_cat2 = new TH1F("signal7_cat2","signal7_cat2",6, xAxis44);
   signal7_cat2->SetBinContent(1,26.60441);
   signal7_cat2->SetBinContent(2,19.37917);
   signal7_cat2->SetBinContent(3,21.91837);
   signal7_cat2->SetBinContent(4,20.66837);
   signal7_cat2->SetBinContent(5,18.58857);
   signal7_cat2->SetBinContent(6,14.63684);
   signal7_cat2->SetEntries(870);
   signal7_cat2->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal7_cat2->SetLineColor(ci);
   signal7_cat2->GetXaxis()->SetLabelFont(42);
   signal7_cat2->GetXaxis()->SetLabelSize(0.035);
   signal7_cat2->GetXaxis()->SetTitleSize(0.035);
   signal7_cat2->GetXaxis()->SetTitleFont(42);
   signal7_cat2->GetYaxis()->SetLabelFont(42);
   signal7_cat2->GetYaxis()->SetLabelSize(0.035);
   signal7_cat2->GetYaxis()->SetTitleSize(0.035);
   signal7_cat2->GetYaxis()->SetTitleFont(42);
   signal7_cat2->GetZaxis()->SetLabelFont(42);
   signal7_cat2->GetZaxis()->SetLabelSize(0.035);
   signal7_cat2->GetZaxis()->SetTitleSize(0.035);
   signal7_cat2->GetZaxis()->SetTitleFont(42);
   signal7_cat2->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal7_cat2"," Vu-DM m = 100 GeV","l");
