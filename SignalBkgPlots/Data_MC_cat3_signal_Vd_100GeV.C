...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal6_cat2 = new TH1F("signal6_cat2","signal6_cat2",6, xAxis44);
   signal6_cat2->SetBinContent(1,23.47338);
   signal6_cat2->SetBinContent(2,19.16221);
   signal6_cat2->SetBinContent(3,15.31723);
   signal6_cat2->SetBinContent(4,16.1235);
   signal6_cat2->SetBinContent(5,12.79331);
   signal6_cat2->SetBinContent(6,12.9806);
   signal6_cat2->SetEntries(737);
   signal6_cat2->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal6_cat2->SetLineColor(ci);
   signal6_cat2->GetXaxis()->SetLabelFont(42);
   signal6_cat2->GetXaxis()->SetLabelSize(0.035);
   signal6_cat2->GetXaxis()->SetTitleSize(0.035);
   signal6_cat2->GetXaxis()->SetTitleFont(42);
   signal6_cat2->GetYaxis()->SetLabelFont(42);
   signal6_cat2->GetYaxis()->SetLabelSize(0.035);
   signal6_cat2->GetYaxis()->SetTitleSize(0.035);
   signal6_cat2->GetYaxis()->SetTitleFont(42);
   signal6_cat2->GetZaxis()->SetLabelFont(42);
   signal6_cat2->GetZaxis()->SetLabelSize(0.035);
   signal6_cat2->GetZaxis()->SetTitleSize(0.035);
   signal6_cat2->GetZaxis()->SetTitleFont(42);
   signal6_cat2->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal6_cat2"," Vd-DM m = 100 GeV","l");
