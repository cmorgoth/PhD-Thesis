...
// ------------>Primitives in pad: pad1
   ...
   TH1F *stack1_stack_3 = new TH1F("stack1_stack_3","",6, xAxis16);
   stack1_stack_3->SetMinimum(0.6446662);
   stack1_stack_3->SetMaximum(7309.741);
   stack1_stack_3->SetDirectory(0);
   stack1_stack_3->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   stack1_stack_3->SetLineColor(ci);
   stack1_stack_3->GetXaxis()->SetTitle("R^{2}");
   stack1_stack_3->GetXaxis()->SetLabelFont(42);
   stack1_stack_3->GetXaxis()->SetLabelSize(0.035);
   stack1_stack_3->GetXaxis()->SetTitleSize(0.035);
   stack1_stack_3->GetXaxis()->SetTitleFont(42);
   stack1_stack_3->GetYaxis()->SetTitle("Events/0.075");
   stack1_stack_3->GetYaxis()->CenterTitle(true);
   stack1_stack_3->GetYaxis()->SetLabelFont(42);
   stack1_stack_3->GetYaxis()->SetLabelSize(0.035);
   stack1_stack_3->GetYaxis()->SetTitleSize(0.035);
   stack1_stack_3->GetYaxis()->SetTitleOffset(1.45);
   stack1_stack_3->GetYaxis()->SetTitleFont(42);
   stack1_stack_3->GetZaxis()->SetLabelFont(42);
   stack1_stack_3->GetZaxis()->SetLabelSize(0.035);
   stack1_stack_3->GetZaxis()->SetTitleSize(0.035);
   stack1_stack_3->GetZaxis()->SetTitleFont(42);
   stack1->SetHistogram(stack1_stack_3);
   
   Double_t xAxis17[7] = {0.5, 0.575, 0.65, 0.75, 0.85, 0.95, 1.2}; 
   
   TH1F *cat2_dy = new TH1F("cat2_dy","",6, xAxis17);
   ...
   TH1F *cat2_tt = new TH1F("cat2_tt","",6, xAxis18);
   ...
   TH1F *cat2_z = new TH1F("cat2_z","",6, xAxis19);
   ...
   TH1F *cat2_w = new TH1F("cat2_w","",6, xAxis20);
   ...
   TH1F *cat2_data = new TH1F("cat2_data","",6, xAxis21);
...
// ------------>Primitives in pad: pad2
   ...
   TH1F *RATIO = new TH1F("RATIO","",6, xAxis22);
