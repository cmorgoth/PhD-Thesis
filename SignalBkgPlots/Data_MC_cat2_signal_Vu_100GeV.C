...
//=========  (Thu Sep 11 01:14:19 2014) by ROOT version5.34/20
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal7_cat1 = new TH1F("signal7_cat1","signal7_cat1",6, xAxis29);
   signal7_cat1->SetBinContent(1,23.16577);
   signal7_cat1->SetBinContent(2,21.34942);
   signal7_cat1->SetBinContent(3,31.02249);
   signal7_cat1->SetBinContent(4,25.87637);
   signal7_cat1->SetBinContent(5,28.1617);
   signal7_cat1->SetBinContent(6,26.59611);
   signal7_cat1->SetEntries(987);
   signal7_cat1->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal7_cat1->SetLineColor(ci);
   signal7_cat1->GetXaxis()->SetLabelFont(42);
   signal7_cat1->GetXaxis()->SetLabelSize(0.035);
   signal7_cat1->GetXaxis()->SetTitleSize(0.035);
   signal7_cat1->GetXaxis()->SetTitleFont(42);
   signal7_cat1->GetYaxis()->SetLabelFont(42);
   signal7_cat1->GetYaxis()->SetLabelSize(0.035);
   signal7_cat1->GetYaxis()->SetTitleSize(0.035);
   signal7_cat1->GetYaxis()->SetTitleFont(42);
   signal7_cat1->GetZaxis()->SetLabelFont(42);
   signal7_cat1->GetZaxis()->SetLabelSize(0.035);
   signal7_cat1->GetZaxis()->SetTitleSize(0.035);
   signal7_cat1->GetZaxis()->SetTitleFont(42);
   signal7_cat1->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal7_cat1"," Vu-DM m = 100 GeV","l");
