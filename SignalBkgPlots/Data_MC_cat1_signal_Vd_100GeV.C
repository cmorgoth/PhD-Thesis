...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal6_cat0 = new TH1F("signal6_cat0","signal6_cat0",11, xAxis14);
   signal6_cat0->SetBinContent(1,12.14946);
   signal6_cat0->SetBinContent(2,13.85366);
   signal6_cat0->SetBinContent(3,17.47131);
   signal6_cat0->SetBinContent(4,15.79293);
   signal6_cat0->SetBinContent(5,16.03624);
   signal6_cat0->SetBinContent(6,17.26432);
   signal6_cat0->SetBinContent(7,18.33629);
   signal6_cat0->SetBinContent(8,17.52418);
   signal6_cat0->SetBinContent(9,14.92129);
   signal6_cat0->SetBinContent(10,17.76394);
   signal6_cat0->SetBinContent(11,27.1392);
   signal6_cat0->SetEntries(1083);
   signal6_cat0->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal6_cat0->SetLineColor(ci);
   signal6_cat0->GetXaxis()->SetLabelFont(42);
   signal6_cat0->GetXaxis()->SetLabelSize(0.035);
   signal6_cat0->GetXaxis()->SetTitleSize(0.035);
   signal6_cat0->GetXaxis()->SetTitleFont(42);
   signal6_cat0->GetYaxis()->SetLabelFont(42);
   signal6_cat0->GetYaxis()->SetLabelSize(0.035);
   signal6_cat0->GetYaxis()->SetTitleSize(0.035);
   signal6_cat0->GetYaxis()->SetTitleFont(42);
   signal6_cat0->GetZaxis()->SetLabelFont(42);
   signal6_cat0->GetZaxis()->SetLabelSize(0.035);
   signal6_cat0->GetZaxis()->SetTitleSize(0.035);
   signal6_cat0->GetZaxis()->SetTitleFont(42);
   signal6_cat0->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal6_cat0"," Vd-DM m = 100 GeV","l");
