...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal7_cat0 = new TH1F("signal7_cat0","signal7_cat0",11, xAxis14);
   signal7_cat0->SetBinContent(1,14.61583);
   signal7_cat0->SetBinContent(2,14.39276);
   signal7_cat0->SetBinContent(3,15.63131);
   signal7_cat0->SetBinContent(4,17.9505);
   signal7_cat0->SetBinContent(5,17.63761);
   signal7_cat0->SetBinContent(6,18.37444);
   signal7_cat0->SetBinContent(7,20.49405);
   signal7_cat0->SetBinContent(8,22.38409);
   signal7_cat0->SetBinContent(9,19.81584);
   signal7_cat0->SetBinContent(10,15.56394);
   signal7_cat0->SetBinContent(11,30.19983);
   signal7_cat0->SetEntries(1162);
   signal7_cat0->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal7_cat0->SetLineColor(ci);
   signal7_cat0->GetXaxis()->SetLabelFont(42);
   signal7_cat0->GetXaxis()->SetLabelSize(0.035);
   signal7_cat0->GetXaxis()->SetTitleSize(0.035);
   signal7_cat0->GetXaxis()->SetTitleFont(42);
   signal7_cat0->GetYaxis()->SetLabelFont(42);
   signal7_cat0->GetYaxis()->SetLabelSize(0.035);
   signal7_cat0->GetYaxis()->SetTitleSize(0.035);
   signal7_cat0->GetYaxis()->SetTitleFont(42);
   signal7_cat0->GetZaxis()->SetLabelFont(42);
   signal7_cat0->GetZaxis()->SetLabelSize(0.035);
   signal7_cat0->GetZaxis()->SetTitleSize(0.035);
   signal7_cat0->GetZaxis()->SetTitleFont(42);
   signal7_cat0->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal7_cat0"," Vu-DM m = 100 GeV","l");
