...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal3_cat3 = new TH1F("signal3_cat3","signal3_cat3",4, xAxis59);
   signal3_cat3->SetBinContent(1,30.24497);
   signal3_cat3->SetBinContent(2,22.54885);
   signal3_cat3->SetBinContent(3,42.16089);
   signal3_cat3->SetBinContent(4,15.024);
   signal3_cat3->SetEntries(789);
   signal3_cat3->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal3_cat3->SetLineColor(ci);
   signal3_cat3->GetXaxis()->SetLabelFont(42);
   signal3_cat3->GetXaxis()->SetLabelSize(0.035);
   signal3_cat3->GetXaxis()->SetTitleSize(0.035);
   signal3_cat3->GetXaxis()->SetTitleFont(42);
   signal3_cat3->GetYaxis()->SetLabelFont(42);
   signal3_cat3->GetYaxis()->SetLabelSize(0.035);
   signal3_cat3->GetYaxis()->SetTitleSize(0.035);
   signal3_cat3->GetYaxis()->SetTitleFont(42);
   signal3_cat3->GetZaxis()->SetLabelFont(42);
   signal3_cat3->GetZaxis()->SetLabelSize(0.035);
   signal3_cat3->GetZaxis()->SetTitleSize(0.035);
   signal3_cat3->GetZaxis()->SetTitleFont(42);
   signal3_cat3->Draw("same");
   pad1->Modified();
   C->cd();
