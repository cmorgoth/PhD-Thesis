...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal3_cat0 = new TH1F("signal3_cat0","signal3_cat0",11, xAxis14);
   signal3_cat0->SetBinContent(1,17.07481);
   signal3_cat0->SetBinContent(2,17.56128);
   signal3_cat0->SetBinContent(3,16.03611);
   signal3_cat0->SetBinContent(4,23.64123);
   signal3_cat0->SetBinContent(5,17.61245);
   signal3_cat0->SetBinContent(6,20.06668);
   signal3_cat0->SetBinContent(7,24.77889);
   signal3_cat0->SetBinContent(8,26.6055);
   signal3_cat0->SetBinContent(9,28.53875);
   signal3_cat0->SetBinContent(10,20.61491);
   signal3_cat0->SetBinContent(11,40.3884);
   signal3_cat0->SetEntries(1410);
   signal3_cat0->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal3_cat0->SetLineColor(ci);
   signal3_cat0->GetXaxis()->SetLabelFont(42);
   signal3_cat0->GetXaxis()->SetLabelSize(0.035);
   signal3_cat0->GetXaxis()->SetTitleSize(0.035);
   signal3_cat0->GetXaxis()->SetTitleFont(42);
   signal3_cat0->GetYaxis()->SetLabelFont(42);
   signal3_cat0->GetYaxis()->SetLabelSize(0.035);
   signal3_cat0->GetYaxis()->SetTitleSize(0.035);
   signal3_cat0->GetYaxis()->SetTitleFont(42);
   signal3_cat0->GetZaxis()->SetLabelFont(42);
   signal3_cat0->GetZaxis()->SetLabelSize(0.035);
   signal3_cat0->GetZaxis()->SetTitleSize(0.035);
   signal3_cat0->GetZaxis()->SetTitleFont(42);
   signal3_cat0->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal3_cat0"," Vu-DM m = 1 TeV","l");
