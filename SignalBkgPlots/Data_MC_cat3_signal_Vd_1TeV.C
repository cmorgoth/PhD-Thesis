...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal2_cat2 = new TH1F("signal2_cat2","signal2_cat2",6, xAxis44);
   signal2_cat2->SetBinContent(1,26.87683);
   signal2_cat2->SetBinContent(2,24.25473);
   signal2_cat2->SetBinContent(3,28.11696);
   signal2_cat2->SetBinContent(4,27.08432);
   signal2_cat2->SetBinContent(5,27.88028);
   signal2_cat2->SetBinContent(6,27.09479);
   signal2_cat2->SetEntries(1170);
   signal2_cat2->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal2_cat2->SetLineColor(ci);
   signal2_cat2->GetXaxis()->SetLabelFont(42);
   signal2_cat2->GetXaxis()->SetLabelSize(0.035);
   signal2_cat2->GetXaxis()->SetTitleSize(0.035);
   signal2_cat2->GetXaxis()->SetTitleFont(42);
   signal2_cat2->GetYaxis()->SetLabelFont(42);
   signal2_cat2->GetYaxis()->SetLabelSize(0.035);
   signal2_cat2->GetYaxis()->SetTitleSize(0.035);
   signal2_cat2->GetYaxis()->SetTitleFont(42);
   signal2_cat2->GetZaxis()->SetLabelFont(42);
   signal2_cat2->GetZaxis()->SetLabelSize(0.035);
   signal2_cat2->GetZaxis()->SetTitleSize(0.035);
   signal2_cat2->GetZaxis()->SetTitleFont(42);
   signal2_cat2->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal2_cat2"," Vd-DM m = 1 TeV","l");
