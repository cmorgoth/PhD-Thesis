...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal2_cat0 = new TH1F("signal2_cat0","signal2_cat0",11, xAxis14);
   signal2_cat0->SetBinContent(1,18.47236);
   signal2_cat0->SetBinContent(2,18.22193);
   signal2_cat0->SetBinContent(3,18.06014);
   signal2_cat0->SetBinContent(4,16.4034);
   signal2_cat0->SetBinContent(5,22.17753);
   signal2_cat0->SetBinContent(6,19.11149);
   signal2_cat0->SetBinContent(7,25.99319);
   signal2_cat0->SetBinContent(8,19.39893);
   signal2_cat0->SetBinContent(9,27.80012);
   signal2_cat0->SetBinContent(10,20.82953);
   signal2_cat0->SetBinContent(11,39.6916);
   signal2_cat0->SetEntries(1402);
   signal2_cat0->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal2_cat0->SetLineColor(ci);
   signal2_cat0->GetXaxis()->SetLabelFont(42);
   signal2_cat0->GetXaxis()->SetLabelSize(0.035);
   signal2_cat0->GetXaxis()->SetTitleSize(0.035);
   signal2_cat0->GetXaxis()->SetTitleFont(42);
   signal2_cat0->GetYaxis()->SetLabelFont(42);
   signal2_cat0->GetYaxis()->SetLabelSize(0.035);
   signal2_cat0->GetYaxis()->SetTitleSize(0.035);
   signal2_cat0->GetYaxis()->SetTitleFont(42);
   signal2_cat0->GetZaxis()->SetLabelFont(42);
   signal2_cat0->GetZaxis()->SetLabelSize(0.035);
   signal2_cat0->GetZaxis()->SetTitleSize(0.035);
   signal2_cat0->GetZaxis()->SetTitleFont(42);
   signal2_cat0->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal2_cat0"," Vd-DM m = 1 TeV","l");
