...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal7_cat3 = new TH1F("signal7_cat3","signal7_cat3",4, xAxis59);
   signal7_cat3->SetBinContent(1,17.78978);
   signal7_cat3->SetBinContent(2,11.58285);
   signal7_cat3->SetBinContent(3,24.23884);
   signal7_cat3->SetBinContent(4,5.785459);
   signal7_cat3->SetEntries(425);
   signal7_cat3->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal7_cat3->SetLineColor(ci);
   signal7_cat3->GetXaxis()->SetLabelFont(42);
   signal7_cat3->GetXaxis()->SetLabelSize(0.035);
   signal7_cat3->GetXaxis()->SetTitleSize(0.035);
   signal7_cat3->GetXaxis()->SetTitleFont(42);
   signal7_cat3->GetYaxis()->SetLabelFont(42);
   signal7_cat3->GetYaxis()->SetLabelSize(0.035);
   signal7_cat3->GetYaxis()->SetTitleSize(0.035);
   signal7_cat3->GetYaxis()->SetTitleFont(42);
   signal7_cat3->GetZaxis()->SetLabelFont(42);
   signal7_cat3->GetZaxis()->SetLabelSize(0.035);
   signal7_cat3->GetZaxis()->SetTitleSize(0.035);
   signal7_cat3->GetZaxis()->SetTitleFont(42);
   signal7_cat3->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal7_cat3"," Vu-DM m = 100 GeV","l");
