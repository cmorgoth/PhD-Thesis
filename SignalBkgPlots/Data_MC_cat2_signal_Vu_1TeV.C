...
// ------------>Primitives in pad: pad1
   ...
   TH1F *signal3_cat1 = new TH1F("signal3_cat1","signal3_cat1",6, xAxis29);
   signal3_cat1->SetBinContent(1,26.34861);
   signal3_cat1->SetBinContent(2,27.01218);
   signal3_cat1->SetBinContent(3,40.7065);
   signal3_cat1->SetBinContent(4,43.24542);
   signal3_cat1->SetBinContent(5,37.77665);
   signal3_cat1->SetBinContent(6,37.2774);
   signal3_cat1->SetEntries(1335);
   signal3_cat1->SetStats(0);

   ci = TColor::GetColor("#000099");
   signal3_cat1->SetLineColor(ci);
   signal3_cat1->GetXaxis()->SetLabelFont(42);
   signal3_cat1->GetXaxis()->SetLabelSize(0.035);
   signal3_cat1->GetXaxis()->SetTitleSize(0.035);
   signal3_cat1->GetXaxis()->SetTitleFont(42);
   signal3_cat1->GetYaxis()->SetLabelFont(42);
   signal3_cat1->GetYaxis()->SetLabelSize(0.035);
   signal3_cat1->GetYaxis()->SetTitleSize(0.035);
   signal3_cat1->GetYaxis()->SetTitleFont(42);
   signal3_cat1->GetZaxis()->SetLabelFont(42);
   signal3_cat1->GetZaxis()->SetLabelSize(0.035);
   signal3_cat1->GetZaxis()->SetTitleSize(0.035);
   signal3_cat1->GetZaxis()->SetTitleFont(42);
   signal3_cat1->Draw("same");
   pad1->Modified();
   C->cd();
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("signal3_cat1"," Vu-DM m = 1 TeV","l");
