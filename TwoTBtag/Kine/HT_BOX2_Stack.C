...
// ------------>Primitives in pad: pad1
   ...
   HT_2mu_5->SetBinContent(3,0.3175495);
   HT_2mu_5->SetBinContent(4,0.5151369);
   HT_2mu_5->SetBinContent(5,0.2030121);
   HT_2mu_5->SetBinContent(6,0.1821363);
   HT_2mu_5->SetBinContent(7,0.06079891);
   HT_2mu_5->SetBinContent(8,0.06746779);
   HT_2mu_5->SetBinContent(9,0.0738749);
   HT_2mu_5->SetBinContent(10,0.01053328);
   HT_2mu_5->SetEntries(42);
   HT_2mu_5->SetStats(0);
   ...
   TH1F *HT_2mu_5 = new TH1F("HT_2mu_5","",20,0,1400);
   HT_2mu_5->SetBinContent(4,0.2924674);
   HT_2mu_5->SetBinContent(5,0.1403534);
   HT_2mu_5->SetBinContent(6,0.06386896);
   HT_2mu_5->SetBinContent(8,0.0164301);
   HT_2mu_5->SetBinContent(12,0.0990027);
   HT_2mu_5->SetEntries(18);
   HT_2mu_5->SetStats(0);
   ...
   Data_HT_2mu_2->SetBinContent(4,4);
   Data_HT_2mu_2->SetBinContent(5,1);
   Data_HT_2mu_2->SetBinError(4,2);
   Data_HT_2mu_2->SetBinError(5,1);
   Data_HT_2mu_2->SetEntries(5);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(4,4.95292);
   RATIO->SetBinContent(5,2.912348);
   RATIO->SetBinError(4,6.042218);
   RATIO->SetBinError(5,5.760525);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(0.8876543);
   RATIO->SetStats(0);
