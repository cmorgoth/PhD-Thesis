...
// ------------>Primitives in pad: pad1
   ...
   PT_1D_J1_5mu_BoxMC->SetBinContent(1,0.7788624);
   PT_1D_J1_5mu_BoxMC->SetBinContent(2,0.3199772);
   PT_1D_J1_5mu_BoxMC->SetBinContent(3,0.1867262);
   PT_1D_J1_5mu_BoxMC->SetBinContent(4,0.1135929);
   PT_1D_J1_5mu_BoxMC->SetBinContent(5,0.01566612);
   PT_1D_J1_5mu_BoxMC->SetBinContent(6,0.01568487);
   PT_1D_J1_5mu_BoxMC->SetEntries(42);
   ...
   TH1F *PT_1D_J1_5mu_BoxMC = new TH1F("PT_1D_J1_5mu_BoxMC","",20,80,1500);
   PT_1D_J1_5mu_BoxMC->SetBinContent(1,0.3945538);
   PT_1D_J1_5mu_BoxMC->SetBinContent(2,0.102136);
   PT_1D_J1_5mu_BoxMC->SetBinContent(4,0.0164301);
   PT_1D_J1_5mu_BoxMC->SetBinContent(5,0.0990027);
   PT_1D_J1_5mu_BoxMC->SetEntries(18);
   PT_1D_J1_5mu_BoxMC->SetStats(0);
   ...
   PT_1D_J1_Data_2mu_Box->SetBinContent(1,4);
   PT_1D_J1_Data_2mu_Box->SetBinContent(2,1);
   PT_1D_J1_Data_2mu_Box->SetBinError(1,2);
   PT_1D_J1_Data_2mu_Box->SetBinError(2,1);
   PT_1D_J1_Data_2mu_Box->SetEntries(5);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,3.40885);
   RATIO->SetBinContent(2,2.369033);
   RATIO->SetBinError(1,1.859082);
   RATIO->SetBinError(2,2.469716);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(3.493621);
   RATIO->SetStats(0);
