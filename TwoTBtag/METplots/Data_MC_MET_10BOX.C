...
// ------------>Primitives in pad: pad1
   ...
   BaseDM_METmag_Box1_plotType0->SetBinContent(1,0.3518586);
   BaseDM_METmag_Box1_plotType0->SetBinContent(2,0.1184944);
   BaseDM_METmag_Box1_plotType0->SetBinContent(3,0.1378913);
   BaseDM_METmag_Box1_plotType0->SetBinContent(4,0.08061519);
   BaseDM_METmag_Box1_plotType0->SetBinContent(6,0.02739812);
   BaseDM_METmag_Box1_plotType0->SetEntries(20);
   ...
   TH1F *BaseDM_METmag_Box1_plotType0 = new TH1F("BaseDM_METmag_Box1_plotType0","BaseDM_METmag_Box1_plotType0",20,0,1500);
   BaseDM_METmag_Box1_plotType0->SetBinContent(1,61.70079);
   BaseDM_METmag_Box1_plotType0->SetBinContent(2,144.0666);
   BaseDM_METmag_Box1_plotType0->SetBinContent(3,117.3753);
   BaseDM_METmag_Box1_plotType0->SetBinContent(4,36.03708);
   BaseDM_METmag_Box1_plotType0->SetBinContent(5,8.992804);
   BaseDM_METmag_Box1_plotType0->SetBinContent(6,2.691624);
   BaseDM_METmag_Box1_plotType0->SetBinContent(7,0.3673025);
   BaseDM_METmag_Box1_plotType0->SetBinContent(8,0.2533048);
   BaseDM_METmag_Box1_plotType0->SetBinContent(9,0.1240135);
   BaseDM_METmag_Box1_plotType0->SetBinContent(10,0.1226436);
   BaseDM_METmag_Box1_plotType0->SetEntries(4920);
   BaseDM_METmag_Box1_plotType0->SetStats(0);
   ...
   TH1F *BaseDM_METmag_Box1_plotType0 = new TH1F("BaseDM_METmag_Box1_plotType0","BaseDM_METmag_Box1_plotType0",20,0,1500);
   BaseDM_METmag_Box1_plotType0->SetBinContent(1,4.370034);
   BaseDM_METmag_Box1_plotType0->SetBinContent(2,5.838755);
   BaseDM_METmag_Box1_plotType0->SetBinContent(3,8.313667);
   BaseDM_METmag_Box1_plotType0->SetBinContent(4,2.661649);
   BaseDM_METmag_Box1_plotType0->SetBinContent(5,1.137835);
   BaseDM_METmag_Box1_plotType0->SetBinContent(6,0.134913);
   BaseDM_METmag_Box1_plotType0->SetBinContent(7,0.1295453);
   BaseDM_METmag_Box1_plotType0->SetEntries(143);
   BaseDM_METmag_Box1_plotType0->SetStats(0);
   ...
   Data_METmag_Box1_plotType0->SetBinContent(1,62);
   Data_METmag_Box1_plotType0->SetBinContent(2,138);
   Data_METmag_Box1_plotType0->SetBinContent(3,83);
   Data_METmag_Box1_plotType0->SetBinContent(4,27);
   Data_METmag_Box1_plotType0->SetBinContent(5,5);
   Data_METmag_Box1_plotType0->SetBinContent(6,2);
   Data_METmag_Box1_plotType0->SetBinError(1,7.874008);
   Data_METmag_Box1_plotType0->SetBinError(2,11.74734);
   Data_METmag_Box1_plotType0->SetBinError(3,9.110434);
   Data_METmag_Box1_plotType0->SetBinError(4,5.196152);
   Data_METmag_Box1_plotType0->SetBinError(5,2.236068);
   Data_METmag_Box1_plotType0->SetBinError(6,1.414214);
   Data_METmag_Box1_plotType0->SetEntries(317);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9334161);
   RATIO->SetBinContent(2,0.9198537);
   RATIO->SetBinContent(3,0.6596367);
   RATIO->SetBinContent(4,0.696247);
   RATIO->SetBinContent(5,0.4935523);
   RATIO->SetBinContent(6,0.7007869);
   RATIO->SetBinError(1,0.1648322);
   RATIO->SetBinError(2,0.1084959);
   RATIO->SetBinError(3,0.09327652);
   RATIO->SetBinError(4,0.1745123);
   RATIO->SetBinError(5,0.2697481);
   RATIO->SetBinError(6,0.6462431);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(34.1092);
   RATIO->SetStats(0);
