...
// ------------>Primitives in pad: pad1
   ...
   BaseDM_METmag_Box2_plotType0->SetBinContent(1,1.407933);
   BaseDM_METmag_Box2_plotType0->SetBinContent(2,0.02257641);
   BaseDM_METmag_Box2_plotType0->SetEntries(42);
   ...
   TH1F *BaseDM_METmag_Box2_plotType0 = new TH1F("BaseDM_METmag_Box2_plotType0","BaseDM_METmag_Box2_plotType0",20,0,1500);
   BaseDM_METmag_Box2_plotType0->SetBinContent(1,0.05048004);
   BaseDM_METmag_Box2_plotType0->SetBinContent(2,0.2743019);
   BaseDM_METmag_Box2_plotType0->SetBinContent(3,0.1326059);
   BaseDM_METmag_Box2_plotType0->SetBinContent(4,0.03930198);
   BaseDM_METmag_Box2_plotType0->SetBinContent(5,0.0164301);
   BaseDM_METmag_Box2_plotType0->SetBinContent(6,0.0990027);
   BaseDM_METmag_Box2_plotType0->SetEntries(18);
   BaseDM_METmag_Box2_plotType0->SetStats(0);
   ...
   Data_METmag_Box2_plotType0->SetBinContent(1,4);
   Data_METmag_Box2_plotType0->SetBinContent(3,1);
   Data_METmag_Box2_plotType0->SetBinError(1,2);
   Data_METmag_Box2_plotType0->SetBinError(3,1);
   Data_METmag_Box2_plotType0->SetEntries(5);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,2.742707);
   RATIO->SetBinContent(3,7.541145);
   RATIO->SetBinError(1,2.653031);
   RATIO->SetBinError(3,22.03918);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(0.2146213);
   RATIO->SetStats(0);
