...
// ------------>Primitives in pad: pad1
   ...
   NJETS2_W->SetBinContent(2,0.9124351);
   NJETS2_W->SetBinContent(3,0.4642719);
   NJETS2_W->SetBinContent(4,0.03168087);
   NJETS2_W->SetBinContent(5,0.02212206);
   NJETS2_W->SetEntries(42);
   NJETS2_W->SetStats(0);
   ...
   NJETS2_W__15->SetBinContent(2,0.04457469);
   NJETS2_W__15->SetBinContent(3,0.3594348);
   NJETS2_W__15->SetBinContent(4,0.1825845);
   NJETS2_W__15->SetBinContent(5,0.02552859);
   NJETS2_W__15->SetEntries(18);
   ...
   TH1F *NJETS2_W = new TH1F("NJETS2_W","NJETS 2 BOX",9,1,10);
   NJETS2_W->SetBinContent(2,4);
   NJETS2_W->SetBinContent(3,1);
   NJETS2_W->SetBinError(2,2);
   NJETS2_W->SetBinError(3,1);
   NJETS2_W->SetEntries(5);
   NJETS2_W->SetStats(0);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(2,4.179686);
   RATIO->SetBinContent(3,1.214024);
   RATIO->SetBinError(2,4.756257);
   RATIO->SetBinError(3,1.806419);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(1.123892);
   RATIO->SetStats(0);
