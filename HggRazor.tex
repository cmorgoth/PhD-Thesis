...
with dedicated searches, using the Higgs mass to suppress SM background processes.


We present a search of this kind in pp collisions at 13 TeV using data from the CMS detector at the CERN LHC.
...
\MR and \Rtwo to define search regions that may contain additional events above the SM prediction
