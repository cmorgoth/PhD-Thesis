...
//=========  (Sat Mar 14 10:51:00 2015) by ROOT version5.34/11
   ...
   Graph_Graph2->SetMinimum(7.812e-42);
   Graph_Graph2->SetMaximum(2.287132e-39);
   ...
   TH1F *Graph_Graph_Graph13 = new TH1F("Graph_Graph_Graph13","",100,0.9,1099.9);
   Graph_Graph_Graph13->SetMinimum(1e-46);
   Graph_Graph_Graph13->SetMaximum(1e-32);
   Graph_Graph_Graph13->SetDirectory(0);
   Graph_Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph13->SetLineColor(ci);
   Graph_Graph_Graph13->GetXaxis()->SetTitle("M_{#chi} (GeV)");
   Graph_Graph_Graph13->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph13->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_Graph13->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph_Graph13->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph13->GetYaxis()->SetTitle("#sigma_{N-#chi} (cm^{2})");
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,225,5475);
   Graph_Graph4->SetMinimum(2.52e-40);
   Graph_Graph4->SetMaximum(3.9572e-38);
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","Graph",100,4.545098,2228.982);
   Graph_Graph5->SetMinimum(3.796754e-39);
   Graph_Graph5->SetMaximum(1.057714e-36);
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","Graph",100,94.43017,1064.255);
   Graph_Graph6->SetMinimum(3.844355e-39);
   Graph_Graph6->SetMaximum(1.836345e-38);
   ...
   Graph_Graph7->SetMinimum(3.078e-39);
   Graph_Graph7->SetMaximum(1.693997e-34);
...
tex->SetNDC();
   ...
   entry=leg->AddEntry("Graph","CMS Monojet","l");
...
tex->SetNDC();
   ...
   c->cd();
   c->SetSelected(c);
   c->SaveAs("SD_TOYS_FINAL_March4_Mono.pdf");
}
