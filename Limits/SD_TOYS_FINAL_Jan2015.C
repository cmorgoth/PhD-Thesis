...
//=========  (Mon Feb  9 12:06:45 2015) by ROOT version5.34/11
   ...
   graph->SetPoint(0,1,3.422137114e-46);
   graph->SetPoint(1,10,1.145378848e-45);
   graph->SetPoint(2,100,1.322013895e-45);
   graph->SetPoint(3,400,4.479537296e-45);
   graph->SetPoint(4,700,1.897438241e-44);
   graph->SetPoint(5,1000,8.510499289e-44);
   ...
   multigraph->Add(graph,"L");
   multigraph->Draw("L");
   TLatex *   tex = new TLatex(0.52,0.68,"#hat{O}_{V} #frac{(#bar{#chi}#gamma_{#mu}#gamma_{5}#chi) (#bar{q}#gamma^{#mu}#gamma_{5}q)}{#Lambda^{2}}");
tex->SetNDC();
   tex->SetTextAlign(22);
   ...
   tex->SetLineWidth(0);
   tex->Draw();
   tex = new TLatex(0.49,0.75,"Spin dependent");
   tex->SetNDC();
   tex->SetTextAlign(22);
   tex->SetTextFont(42);
   ...
   TLegend *leg = new TLegend(0.38,0.77,0.65,0.925,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Graph","Razor-0 #mu DM, g_{ eff} = 1","l");
   ...
   entry=leg->AddEntry("Graph0","Razor-0 #mu DM, g_{ eff} = 4 #pi","l");
   ...
   leg = new TLegend(0.72,0.65,0.95,0.92,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextSize(0.035);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
...
tex->SetNDC();
   ...
   c->SaveAs("SD_TOYS_FINAL_Jan2015.pdf");
}
