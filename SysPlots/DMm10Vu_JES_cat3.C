...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.09642982,0.2895718);
   grae->SetPoint(1,0.6125,24.2545);
   grae->SetPointError(1,0.03749999,0.03749999,0.9057217,1.237936);
   grae->SetPoint(2,0.7,27.86115);
   grae->SetPointError(2,0.05000001,0.05000001,0.1934719,1.259825);
   grae->SetPoint(3,0.8,24.9127);
   grae->SetPointError(3,0.05000001,0.05000001,0.9178257,0.8313427);
   grae->SetPoint(4,0.9,21.51864);
   grae->SetPointError(4,0.04999998,0.04999998,0.9658375,0.8844204);
   grae->SetPoint(5,1.075,19.04998);
   grae->SetPointError(5,0.125,0.125,0.01104736,0.5801868);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.1904998);
   Graph_Graph5->SetMaximum(41.79172);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal11_cat2",6, xAxis3);
   h2clone__3->SetBinContent(1,28.8872);
   h2clone__3->SetBinContent(2,24.2545);
   h2clone__3->SetBinContent(3,27.86115);
   h2clone__3->SetBinContent(4,24.9127);
   h2clone__3->SetBinContent(5,21.51864);
   h2clone__3->SetBinContent(6,19.04998);
   h2clone__3->SetEntries(1061);
   ...
   Graph_Graph_Graph56->SetMinimum(0.1904998);
   Graph_Graph_Graph56->SetMaximum(41.79172);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.00333815,0.01002422);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.03734242,0.05103943);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.006944147,0.04521798);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.03684168,0.03337023);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.04488376,0.0411002);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.0005799147,0.03045603);
   ...
   TH1F *h4clone__4 = new TH1F("h4clone__4","signal11_cat2",6, xAxis4);
