...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,12.3996,1.2875,848.926);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_2mu_Box->SetBinContent(1,588.6718);
   Data_cat3_1D_2mu_Box->SetBinContent(2,326.2262);
   Data_cat3_1D_2mu_Box->SetBinContent(3,280.5255);
   Data_cat3_1D_2mu_Box->SetBinContent(4,238.3564);
   Data_cat3_1D_2mu_Box->SetBinContent(5,170.2276);
   Data_cat3_1D_2mu_Box->SetBinContent(6,79.71698);
   Data_cat3_1D_2mu_Box->SetBinError(1,417.423);
   Data_cat3_1D_2mu_Box->SetBinError(2,425.8959);
   Data_cat3_1D_2mu_Box->SetBinError(3,66.9676);
   Data_cat3_1D_2mu_Box->SetBinError(4,68.73496);
   Data_cat3_1D_2mu_Box->SetBinError(5,515.6105);
   Data_cat3_1D_2mu_Box->SetBinError(6,17.879);
   Data_cat3_1D_2mu_Box->SetMinimum(12.3996);
   Data_cat3_1D_2mu_Box->SetMaximum(765.2734);
   Data_cat3_1D_2mu_Box->SetEntries(1735.731);
   ...
   h1clone->SetBinContent(1,588.6718);
   h1clone->SetBinContent(2,326.2262);
   h1clone->SetBinContent(3,280.5255);
   h1clone->SetBinContent(4,238.3564);
   h1clone->SetBinContent(5,170.2276);
   h1clone->SetBinContent(6,79.71698);
   h1clone->SetBinError(1,417.423);
   h1clone->SetBinError(2,425.8959);
   h1clone->SetBinError(3,66.9676);
   h1clone->SetBinError(4,68.73496);
   h1clone->SetBinError(5,515.6105);
   h1clone->SetBinError(6,17.879);
   h1clone->SetEntries(1735.731);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat3_1D_2mu_Box","R^{2} Bkg Pred. ISR Down","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.001942);
   RATIO->SetBinContent(2,1.003681);
   RATIO->SetBinContent(3,1.004201);
   RATIO->SetBinContent(4,1.00606);
   RATIO->SetBinContent(5,1.005235);
   RATIO->SetBinContent(6,1.006691);
   RATIO->SetBinError(1,0.7104697);
   RATIO->SetBinError(2,1.310329);
   RATIO->SetBinError(3,0.2397249);
   RATIO->SetBinError(4,0.2901181);
   RATIO->SetBinError(5,3.044805);
   RATIO->SetBinError(6,0.2257816);
