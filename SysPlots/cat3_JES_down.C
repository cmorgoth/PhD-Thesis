...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,12.3996,1.2875,850.4371);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_2mu_Box->SetBinContent(1,589.718);
   Data_cat3_1D_2mu_Box->SetBinContent(2,324.1594);
   Data_cat3_1D_2mu_Box->SetBinContent(3,280.3969);
   Data_cat3_1D_2mu_Box->SetBinContent(4,233.3107);
   Data_cat3_1D_2mu_Box->SetBinContent(5,167.9651);
   Data_cat3_1D_2mu_Box->SetBinContent(6,78.68103);
   Data_cat3_1D_2mu_Box->SetBinError(1,423.9091);
   Data_cat3_1D_2mu_Box->SetBinError(2,417.5555);
   Data_cat3_1D_2mu_Box->SetBinError(3,67.43871);
   Data_cat3_1D_2mu_Box->SetBinError(4,64.72156);
   Data_cat3_1D_2mu_Box->SetBinError(5,501.3043);
   Data_cat3_1D_2mu_Box->SetBinError(6,17.86633);
   Data_cat3_1D_2mu_Box->SetMinimum(12.3996);
   Data_cat3_1D_2mu_Box->SetMaximum(766.6333);
   Data_cat3_1D_2mu_Box->SetEntries(1700.963);
   ...
   h1clone->SetBinContent(1,589.718);
   h1clone->SetBinContent(2,324.1594);
   h1clone->SetBinContent(3,280.3969);
   h1clone->SetBinContent(4,233.3107);
   h1clone->SetBinContent(5,167.9651);
   h1clone->SetBinContent(6,78.68103);
   h1clone->SetBinError(1,423.9091);
   h1clone->SetBinError(2,417.5555);
   h1clone->SetBinError(3,67.43871);
   h1clone->SetBinError(4,64.72156);
   h1clone->SetBinError(5,501.3043);
   h1clone->SetBinError(6,17.86633);
   h1clone->SetEntries(1700.963);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat3_1D_2mu_Box","R^{2} Bkg Pred. JES Down","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.003722);
   RATIO->SetBinContent(2,0.9973222);
   RATIO->SetBinContent(3,1.003741);
   RATIO->SetBinContent(4,0.9847631);
   RATIO->SetBinContent(5,0.9918745);
   RATIO->SetBinContent(6,0.9936088);
   RATIO->SetBinError(1,0.7215093);
   RATIO->SetBinError(2,1.284669);
   RATIO->SetBinError(3,0.2414113);
   RATIO->SetBinError(4,0.2731782);
   RATIO->SetBinError(5,2.960323);
   RATIO->SetBinError(6,0.2256216);
