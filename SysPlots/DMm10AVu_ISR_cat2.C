...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,3.221355,2.797373);
   grae->SetPoint(1,0.6125,29.22299);
   grae->SetPointError(1,0.03749999,0.03749999,4.328434,3.758759);
   grae->SetPoint(2,0.7,35.35109);
   grae->SetPointError(2,0.05000001,0.05000001,6.209496,5.392258);
   grae->SetPoint(3,0.8,31.93418);
   grae->SetPointError(3,0.05000001,0.05000001,6.027554,5.234297);
   grae->SetPoint(4,0.9,38.67664);
   grae->SetPointError(4,0.04999998,0.04999998,7.470913,6.487637);
   grae->SetPoint(5,1.075,31.52045);
   grae->SetPointError(5,0.125,0.125,6.088583,5.287245);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.279861);
   Graph_Graph1->SetMaximum(47.28067);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal9_cat1",6, xAxis1);
   h2clone__1->SetBinContent(1,27.9861);
   h2clone__1->SetBinContent(2,29.22299);
   h2clone__1->SetBinContent(3,35.35109);
   h2clone__1->SetBinContent(4,31.93418);
   h2clone__1->SetBinContent(5,38.67664);
   h2clone__1->SetBinContent(6,31.52045);
   h2clone__1->SetEntries(1533);
   ...
   Graph_Graph_Graph12->SetMinimum(0.279861);
   Graph_Graph_Graph12->SetMaximum(47.28067);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.1151056,0.09995581);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1481174,0.1286233);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1756522,0.1525344);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.1887493,0.1639089);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1931634,0.1677404);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.193163,0.1677402);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal9_cat1",6, xAxis2);
