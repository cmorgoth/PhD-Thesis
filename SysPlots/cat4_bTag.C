...
//=========  (Wed Jun 25 16:00:55 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,-19.18422,1.291,173.6471);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.55,100.6924);
   grae->SetPointError(0,0.05000001,0.05000001,0.8815002,0.8815002);
   grae->SetPoint(1,0.65,52.49703);
   grae->SetPointError(1,0.04999998,0.04999998,0.9015884,0.9015884);
   grae->SetPoint(2,0.825,76.92896);
   grae->SetPointError(2,0.125,0.125,2.69133,2.69133);
   grae->SetPoint(3,1.075,9.789645);
   grae->SetPointError(3,0.125,0.125,0.07043266,0.07043266);
   
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,0.43,1.27);
   Graph_Graph7->SetMinimum(0.09890731);
   Graph_Graph7->SetMaximum(154.3639);
   ...
   Graph_Graph_Graph78->SetMinimum(0.09890731);
   Graph_Graph_Graph78->SetMaximum(154.3639);
   ...
   TLegendEntry *entry=leg->AddEntry("Graph0"," bTag Syst.","lf");
