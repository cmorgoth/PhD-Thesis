...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.1031303,1.838367);
   grae->SetPoint(1,0.65,28.01335);
   grae->SetPointError(1,0.04999998,0.04999998,0.9236794,0.2220001);
   grae->SetPoint(2,0.825,59.34517);
   grae->SetPointError(2,0.125,0.125,1.313309,1.103737);
   grae->SetPoint(3,1.075,19.43148);
   grae->SetPointError(3,0.125,0.125,0.1365452,0.1184177);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.1943148);
   Graph_Graph5->SetMaximum(89.01775);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal23_cat3",4, xAxis3);
   h2clone__3->SetBinContent(1,46.06196);
   h2clone__3->SetBinContent(2,28.01335);
   h2clone__3->SetBinContent(3,59.34517);
   h2clone__3->SetBinContent(4,19.43148);
   h2clone__3->SetEntries(1087);
   ...
   Graph_Graph_Graph56->SetMinimum(0.1943148);
   Graph_Graph_Graph56->SetMaximum(89.01775);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.002238948,0.03991075);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.03297283,0.007924797);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.02213,0.0185986);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.007027007,0.006094117);
