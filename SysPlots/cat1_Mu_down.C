...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,149.1601,1.2875,3366.661);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_2mu_Box->SetBinContent(1,2342.239);
   Data_cat1_1D_2mu_Box->SetBinContent(2,1780.835);
   Data_cat1_1D_2mu_Box->SetBinContent(3,1510.998);
   Data_cat1_1D_2mu_Box->SetBinContent(4,1251.606);
   Data_cat1_1D_2mu_Box->SetBinContent(5,1122.199);
   Data_cat1_1D_2mu_Box->SetBinContent(6,1113.164);
   Data_cat1_1D_2mu_Box->SetBinContent(7,946.4507);
   Data_cat1_1D_2mu_Box->SetBinContent(8,919.4969);
   Data_cat1_1D_2mu_Box->SetBinContent(9,695.9797);
   Data_cat1_1D_2mu_Box->SetBinContent(10,516.8734);
   Data_cat1_1D_2mu_Box->SetBinContent(11,785.9009);
   Data_cat1_1D_2mu_Box->SetBinError(1,445.1808);
   Data_cat1_1D_2mu_Box->SetBinError(2,398.0427);
   Data_cat1_1D_2mu_Box->SetBinError(3,151.4218);
   Data_cat1_1D_2mu_Box->SetBinError(4,127.8076);
   Data_cat1_1D_2mu_Box->SetBinError(5,78.56154);
   Data_cat1_1D_2mu_Box->SetBinError(6,89.11422);
   Data_cat1_1D_2mu_Box->SetBinError(7,122.8661);
   Data_cat1_1D_2mu_Box->SetBinError(8,164.6629);
   Data_cat1_1D_2mu_Box->SetBinError(9,105.3711);
   Data_cat1_1D_2mu_Box->SetBinError(10,122.4985);
   Data_cat1_1D_2mu_Box->SetBinError(11,39.2384);
   Data_cat1_1D_2mu_Box->SetMinimum(149.1601);
   Data_cat1_1D_2mu_Box->SetMaximum(3044.911);
   Data_cat1_1D_2mu_Box->SetEntries(12431.13);
   ...
   h1clone->SetBinContent(1,2342.239);
   h1clone->SetBinContent(2,1780.835);
   h1clone->SetBinContent(3,1510.998);
   h1clone->SetBinContent(4,1251.606);
   h1clone->SetBinContent(5,1122.199);
   h1clone->SetBinContent(6,1113.164);
   h1clone->SetBinContent(7,946.4507);
   h1clone->SetBinContent(8,919.4969);
   h1clone->SetBinContent(9,695.9797);
   h1clone->SetBinContent(10,516.8734);
   h1clone->SetBinContent(11,785.9009);
   h1clone->SetBinError(1,445.1808);
   h1clone->SetBinError(2,398.0427);
   h1clone->SetBinError(3,151.4218);
   h1clone->SetBinError(4,127.8076);
   h1clone->SetBinError(5,78.56154);
   h1clone->SetBinError(6,89.11422);
   h1clone->SetBinError(7,122.8661);
   h1clone->SetBinError(8,164.6629);
   h1clone->SetBinError(9,105.3711);
   h1clone->SetBinError(10,122.4985);
   h1clone->SetBinError(11,39.2384);
   h1clone->SetEntries(12431.13);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat1_1D_2mu_Box","R^{2} Bkg Pred. Mu down","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.001142);
   RATIO->SetBinContent(2,1.001182);
   RATIO->SetBinContent(3,1.001187);
   RATIO->SetBinContent(4,1.001175);
   RATIO->SetBinContent(5,1.001158);
   RATIO->SetBinContent(6,1.001215);
   RATIO->SetBinContent(7,1.001148);
   RATIO->SetBinContent(8,1.00117);
   RATIO->SetBinContent(9,1.001182);
   RATIO->SetBinContent(10,1.001187);
   RATIO->SetBinContent(11,1.001165);
   RATIO->SetBinError(1,0.1902834);
   RATIO->SetBinError(2,0.2237789);
   RATIO->SetBinError(3,0.1003321);
   RATIO->SetBinError(4,0.1022348);
   RATIO->SetBinError(5,0.07008788);
   RATIO->SetBinError(6,0.08015212);
   RATIO->SetBinError(7,0.1299668);
   RATIO->SetBinError(8,0.1792889);
   RATIO->SetBinError(9,0.1515787);
   RATIO->SetBinError(10,0.2372804);
   RATIO->SetBinError(11,0.0499861);
