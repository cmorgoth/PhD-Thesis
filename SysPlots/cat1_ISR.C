...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPoint(0,0.525,2339.336);
   grae->SetPointError(0,0.02500001,0.02500001,0.1275635,0.1275635);
   grae->SetPoint(1,0.575,1778.464);
   grae->SetPointError(1,0.02500001,0.02500001,0.421814,0.421814);
   grae->SetPoint(2,0.625,1509.031);
   grae->SetPointError(2,0.02499998,0.02499998,0.2166138,0.2166138);
   grae->SetPoint(3,0.675,1250.062);
   grae->SetPointError(3,0.02500001,0.02500001,0.7340698,0.7340698);
   grae->SetPoint(4,0.725,1120.574);
   grae->SetPointError(4,0.02500001,0.02500001,2.077393,2.077393);
   grae->SetPoint(5,0.775,1111.9);
   grae->SetPointError(5,0.02500001,0.02500001,1.155701,1.155701);
   grae->SetPoint(6,0.825,945.3574);
   grae->SetPointError(6,0.02500001,0.02500001,0.03356934,0.03356934);
   grae->SetPoint(7,0.875,918.199);
   grae->SetPointError(7,0.02499998,0.02499998,1.699951,1.699951);
   grae->SetPoint(8,0.925,694.8904);
   grae->SetPointError(8,0.02500001,0.02500001,1.434143,1.434143);
   grae->SetPoint(9,0.975,516.1392);
   grae->SetPointError(9,0.02500001,0.02500001,0.8489685,0.8489685);
   grae->SetPoint(10,1.1,784.5536);
   grae->SetPointError(10,0.1,0.1,3.229126,3.229126);
