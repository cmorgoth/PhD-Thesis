...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPoint(0,0.525,2333.309);
   grae->SetPointError(0,0.02500001,0.02500001,20.93152,20.93152);
   grae->SetPoint(1,0.575,1786.878);
   grae->SetPointError(1,0.02500001,0.02500001,30.58002,30.58002);
   grae->SetPoint(2,0.625,1505.003);
   grae->SetPointError(2,0.02499998,0.02499998,13.29773,13.29773);
   grae->SetPoint(3,0.675,1253.731);
   grae->SetPointError(3,0.02500001,0.02500001,12.90912,12.90912);
   grae->SetPoint(4,0.725,1130.448);
   grae->SetPointError(4,0.02500001,0.02500001,20.15173,20.15173);
   grae->SetPoint(5,0.775,1103.679);
   grae->SetPointError(5,0.02500001,0.02500001,10.29852,10.29852);
   grae->SetPoint(6,0.825,946.657);
   grae->SetPointError(6,0.02500001,0.02500001,15.63641,15.63641);
   grae->SetPoint(7,0.875,922.0591);
   grae->SetPointError(7,0.02499998,0.02499998,17.12711,17.12711);
   grae->SetPoint(8,0.925,696.613);
   grae->SetPointError(8,0.02500001,0.02500001,8.573303,8.573303);
   grae->SetPoint(9,0.975,522.3024);
   grae->SetPointError(9,0.02500001,0.02500001,12.3725,12.3725);
   grae->SetPoint(10,1.1,784.361);
   grae->SetPointError(10,0.1,0.1,17.15726,17.15726);
