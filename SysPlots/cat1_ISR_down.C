...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,149.1601,1.2875,3362.283);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_2mu_Box->SetBinContent(1,2339.208);
   Data_cat1_1D_2mu_Box->SetBinContent(2,1778.042);
   Data_cat1_1D_2mu_Box->SetBinContent(3,1509.248);
   Data_cat1_1D_2mu_Box->SetBinContent(4,1250.796);
   Data_cat1_1D_2mu_Box->SetBinContent(5,1118.497);
   Data_cat1_1D_2mu_Box->SetBinContent(6,1113.056);
   Data_cat1_1D_2mu_Box->SetBinContent(7,945.3909);
   Data_cat1_1D_2mu_Box->SetBinContent(8,916.4991);
   Data_cat1_1D_2mu_Box->SetBinContent(9,693.4563);
   Data_cat1_1D_2mu_Box->SetBinContent(10,515.2902);
   Data_cat1_1D_2mu_Box->SetBinContent(11,781.3245);
   Data_cat1_1D_2mu_Box->SetBinError(1,454.3404);
   Data_cat1_1D_2mu_Box->SetBinError(2,404.0435);
   Data_cat1_1D_2mu_Box->SetBinError(3,157.0344);
   Data_cat1_1D_2mu_Box->SetBinError(4,125.5255);
   Data_cat1_1D_2mu_Box->SetBinError(5,78.6851);
   Data_cat1_1D_2mu_Box->SetBinError(6,88.80879);
   Data_cat1_1D_2mu_Box->SetBinError(7,123.0251);
   Data_cat1_1D_2mu_Box->SetBinError(8,162.67);
   Data_cat1_1D_2mu_Box->SetBinError(9,105.1099);
   Data_cat1_1D_2mu_Box->SetBinError(10,121.33);
   Data_cat1_1D_2mu_Box->SetBinError(11,39.94792);
   Data_cat1_1D_2mu_Box->SetMinimum(149.1601);
   Data_cat1_1D_2mu_Box->SetMaximum(3040.971);
   Data_cat1_1D_2mu_Box->SetEntries(12421.73);
   ...
   h1clone->SetBinContent(1,2339.208);
   h1clone->SetBinContent(2,1778.042);
   h1clone->SetBinContent(3,1509.248);
   h1clone->SetBinContent(4,1250.796);
   h1clone->SetBinContent(5,1118.497);
   h1clone->SetBinContent(6,1113.056);
   h1clone->SetBinContent(7,945.3909);
   h1clone->SetBinContent(8,916.4991);
   h1clone->SetBinContent(9,693.4563);
   h1clone->SetBinContent(10,515.2902);
   h1clone->SetBinContent(11,781.3245);
   h1clone->SetBinError(1,454.3404);
   h1clone->SetBinError(2,404.0435);
   h1clone->SetBinError(3,157.0344);
   h1clone->SetBinError(4,125.5255);
   h1clone->SetBinError(5,78.6851);
   h1clone->SetBinError(6,88.80879);
   h1clone->SetBinError(7,123.0251);
   h1clone->SetBinError(8,162.67);
   h1clone->SetBinError(9,105.1099);
   h1clone->SetBinError(10,121.33);
   h1clone->SetBinError(11,39.94792);
   h1clone->SetEntries(12421.73);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat1_1D_2mu_Box","R^{2} Bkg Pred. ISR Down","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9998469);
   RATIO->SetBinContent(2,0.9996123);
   RATIO->SetBinContent(3,1.000028);
   RATIO->SetBinContent(4,1.000527);
   RATIO->SetBinContent(5,0.9978554);
   RATIO->SetBinContent(6,1.001117);
   RATIO->SetBinContent(7,1.000027);
   RATIO->SetBinContent(8,0.9979063);
   RATIO->SetBinContent(9,0.9975526);
   RATIO->SetBinContent(10,0.9981202);
   RATIO->SetBinContent(11,0.9953355);
   RATIO->SetBinError(1,0.1941985);
   RATIO->SetBinError(2,0.2271525);
   RATIO->SetBinError(3,0.1040511);
   RATIO->SetBinError(4,0.1004093);
   RATIO->SetBinError(5,0.07019812);
   RATIO->SetBinError(6,0.07987741);
   RATIO->SetBinError(7,0.130135);
   RATIO->SetBinError(8,0.177119);
   RATIO->SetBinError(9,0.1512029);
   RATIO->SetBinError(10,0.2350169);
   RATIO->SetBinError(11,0.05088997);
