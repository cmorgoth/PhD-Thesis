...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,12.3996,1.2875,832.7089);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_2mu_Box->SetBinContent(1,577.4446);
   Data_cat3_1D_2mu_Box->SetBinContent(2,322.5318);
   Data_cat3_1D_2mu_Box->SetBinContent(3,274.9617);
   Data_cat3_1D_2mu_Box->SetBinContent(4,230.9308);
   Data_cat3_1D_2mu_Box->SetBinContent(5,168.8727);
   Data_cat3_1D_2mu_Box->SetBinContent(6,78.7663);
   Data_cat3_1D_2mu_Box->SetBinError(1,415.7939);
   Data_cat3_1D_2mu_Box->SetBinError(2,425.4952);
   Data_cat3_1D_2mu_Box->SetBinError(3,64.96093);
   Data_cat3_1D_2mu_Box->SetBinError(4,63.60449);
   Data_cat3_1D_2mu_Box->SetBinError(5,523.3977);
   Data_cat3_1D_2mu_Box->SetBinError(6,18.6883);
   Data_cat3_1D_2mu_Box->SetMinimum(12.3996);
   Data_cat3_1D_2mu_Box->SetMaximum(750.678);
   Data_cat3_1D_2mu_Box->SetEntries(1740.367);
   ...
   h1clone->SetBinContent(1,577.4446);
   h1clone->SetBinContent(2,322.5318);
   h1clone->SetBinContent(3,274.9617);
   h1clone->SetBinContent(4,230.9308);
   h1clone->SetBinContent(5,168.8727);
   h1clone->SetBinContent(6,78.7663);
   h1clone->SetBinError(1,415.7939);
   h1clone->SetBinError(2,425.4952);
   h1clone->SetBinError(3,64.96093);
   h1clone->SetBinError(4,63.60449);
   h1clone->SetBinError(5,523.3977);
   h1clone->SetBinError(6,18.6883);
   h1clone->SetEntries(1740.367);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat3_1D_2mu_Box","R^{2} Bkg Pred. bTag Down","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9828326);
   RATIO->SetBinContent(2,0.9923149);
   RATIO->SetBinContent(3,0.9842843);
   RATIO->SetBinContent(4,0.9747179);
   RATIO->SetBinContent(5,0.9972343);
   RATIO->SetBinContent(6,0.9946857);
   RATIO->SetBinError(1,0.707697);
   RATIO->SetBinError(2,1.309096);
   RATIO->SetBinError(3,0.2325415);
   RATIO->SetBinError(4,0.2684633);
   RATIO->SetBinError(5,3.09079);
   RATIO->SetBinError(6,0.2360017);
