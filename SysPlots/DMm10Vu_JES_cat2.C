...
//=========  (Sat Jul 12 16:05:43 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,0.3027753,1.291,57.43454);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.5375,30.27753);
   grae->SetPointError(0,0.03749999,0.03749999,0.7366467,0.2308693);
   grae->SetPoint(1,0.6125,26.8599);
   grae->SetPointError(1,0.03749999,0.03749999,0.5941391,1.468611);
   grae->SetPoint(2,0.7,34.07595);
   grae->SetPointError(2,0.05000001,0.05000001,0.3557434,0.8380852);
   grae->SetPoint(3,0.8,34.16554);
   grae->SetPointError(3,0.05000001,0.05000001,0.9097328,1.748959);
   grae->SetPoint(4,0.9,32.31069);
   grae->SetPointError(4,0.04999998,0.04999998,0.4162598,0.00377655);
   grae->SetPoint(5,1.075,34.48091);
   grae->SetPointError(5,0.125,0.125,0.8137054,0.06311035);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.3027753);
   Graph_Graph5->SetMaximum(51.72136);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal11_cat1",6, xAxis3);
   h2clone__3->SetBinContent(1,30.27753);
   h2clone__3->SetBinContent(2,26.8599);
   h2clone__3->SetBinContent(3,34.07595);
   h2clone__3->SetBinContent(4,34.16554);
   h2clone__3->SetBinContent(5,32.31069);
   h2clone__3->SetBinContent(6,34.48091);
   h2clone__3->SetEntries(1193);
   ...
   Graph_Graph_Graph56->SetMinimum(0.3027753);
   Graph_Graph_Graph56->SetMaximum(51.72136);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.02432981,0.007625102);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.02211993,0.0546767);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.01043972,0.02459462);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.0266272,0.05119072);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.01288304,0.0001168824);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.02359872,0.001830298);
   ...
   TH1F *h4clone__4 = new TH1F("h4clone__4","signal11_cat1",6, xAxis4);
