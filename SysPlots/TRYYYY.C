...
//=========  (Wed Jun  4 22:49:07 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.3249999,49.3927,1.375,2808.684);
   pad1->SetFillColor(0);
   ...
   Graph_Graph1->SetMinimum(325.3219);
   Graph_Graph1->SetMaximum(2532.755);
   ...
   Graph_Graph_Graph12->SetMinimum(325.3219);
   Graph_Graph_Graph12->SetMaximum(2532.755);
   ...
   TLegendEntry *entry=leg->AddEntry("Graph0"," Bkg Pred. Mu down","lf");
