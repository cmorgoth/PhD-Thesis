...
//=========  (Sat Jul 12 16:04:31 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,0.06139977,1.291,43.99615);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.55,21.76858);
   grae->SetPointError(0,0.05000001,0.05000001,0.9155064,0.9155064);
   grae->SetPoint(1,0.65,15.07168);
   grae->SetPointError(1,0.04999998,0.04999998,0.8774357,0.8774357);
   grae->SetPoint(2,0.825,26.40178);
   grae->SetPointError(2,0.125,0.125,1.917809,1.917809);
   grae->SetPoint(3,1.075,6.139977);
   grae->SetPointError(3,0.125,0.125,0.6888328,0.6888328);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.06139977);
   Graph_Graph9->SetMaximum(39.60267);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal11_cat3",4, xAxis5);
   h2clone__5->SetBinContent(1,21.76858);
   h2clone__5->SetBinContent(2,15.07168);
   h2clone__5->SetBinContent(3,26.40178);
   h2clone__5->SetBinContent(4,6.139977);
   h2clone__5->SetEntries(500);
   ...
   Graph_Graph_Graph910->SetMinimum(0.06139977);
   Graph_Graph_Graph910->SetMaximum(39.60267);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.04205632,0.04205632);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.05821752,0.05821752);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.07263936,0.07263936);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.1121882,0.1121882);
