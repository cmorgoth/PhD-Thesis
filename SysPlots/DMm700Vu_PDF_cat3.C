...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,1.393768,1.393768);
   grae->SetPoint(1,0.6125,33.49949);
   grae->SetPointError(1,0.03749999,0.03749999,1.256996,1.256996);
   grae->SetPoint(2,0.7,46.40976);
   grae->SetPointError(2,0.05000001,0.05000001,2.041939,2.041939);
   grae->SetPoint(3,0.8,40.10632);
   grae->SetPointError(3,0.05000001,0.05000001,0.8589287,0.8589287);
   grae->SetPoint(4,0.9,38.83153);
   grae->SetPointError(4,0.04999998,0.04999998,1.542694,1.542694);
   grae->SetPoint(5,1.075,39.69516);
   grae->SetPointError(5,0.125,0.125,0.7076988,0.7076988);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.4556787);
   Graph_Graph9->SetMaximum(59.54274);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal23_cat2",6, xAxis5);
   h2clone__5->SetBinContent(1,45.56787);
   h2clone__5->SetBinContent(2,33.49949);
   h2clone__5->SetBinContent(3,46.40976);
   h2clone__5->SetBinContent(4,40.10632);
   h2clone__5->SetBinContent(5,38.83153);
   h2clone__5->SetBinContent(6,39.69516);
   h2clone__5->SetEntries(1775);
   ...
   Graph_Graph_Graph910->SetMinimum(0.4556787);
   Graph_Graph_Graph910->SetMaximum(59.54274);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.03058665,0.03058665);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.03752284,0.03752284);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.04399804,0.04399804);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.02141629,0.02141629);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.03972788,0.03972788);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.01782834,0.01782834);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal23_cat2",6, xAxis6);
