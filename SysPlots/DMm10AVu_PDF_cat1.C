...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.02500001,0.02500001,0.1440754,0.1440754);
   grae->SetPoint(1,0.575,21.99376);
   grae->SetPointError(1,0.02500001,0.02500001,0.5994816,0.5994816);
   grae->SetPoint(2,0.625,17.87181);
   grae->SetPointError(2,0.02499998,0.02499998,0.2527676,0.2527676);
   grae->SetPoint(3,0.675,21.68442);
   grae->SetPointError(3,0.02500001,0.02500001,0.3249321,0.3249321);
   grae->SetPoint(4,0.725,18.43705);
   grae->SetPointError(4,0.02500001,0.02500001,0.4914742,0.4914742);
   grae->SetPoint(5,0.775,25.04352);
   grae->SetPointError(5,0.02500001,0.02500001,0.7664127,0.7664127);
   grae->SetPoint(6,0.825,21.57135);
   grae->SetPointError(6,0.02500001,0.02500001,0.1829624,0.1829624);
   grae->SetPoint(7,0.875,19.72148);
   grae->SetPointError(7,0.02499998,0.02499998,0.1487274,0.1487274);
   grae->SetPoint(8,0.925,24.68019);
   grae->SetPointError(8,0.02500001,0.02500001,0.6611195,0.6611195);
   grae->SetPoint(9,0.975,25.29433);
   grae->SetPointError(9,0.02500001,0.02500001,0.7004166,0.7004166);
   grae->SetPoint(10,1.1,42.16911);
   grae->SetPointError(10,0.1,0.1,1.071354,1.071354);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.1832774);
   Graph_Graph9->SetMaximum(63.25367);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal9_cat0",11, xAxis5);
   h2clone__5->SetBinContent(1,18.32774);
   h2clone__5->SetBinContent(2,21.99376);
   h2clone__5->SetBinContent(3,17.87181);
   h2clone__5->SetBinContent(4,21.68442);
   h2clone__5->SetBinContent(5,18.43705);
   h2clone__5->SetBinContent(6,25.04352);
   h2clone__5->SetBinContent(7,21.57135);
   h2clone__5->SetBinContent(8,19.72148);
   h2clone__5->SetBinContent(9,24.68019);
   h2clone__5->SetBinContent(10,25.29433);
   h2clone__5->SetBinContent(11,42.16911);
   h2clone__5->SetEntries(1817);
   ...
   Graph_Graph_Graph910->SetMinimum(0.1832774);
   Graph_Graph_Graph910->SetMaximum(63.25367);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.02500001,0.02500001,0.007861058,0.007861058);
   grae->SetPoint(1,0.575,1);
   grae->SetPointError(1,0.02500001,0.02500001,0.02725689,0.02725689);
   grae->SetPoint(2,0.625,1);
   grae->SetPointError(2,0.02499998,0.02499998,0.01414337,0.01414337);
   grae->SetPoint(3,0.675,1);
   grae->SetPointError(3,0.02500001,0.02500001,0.01498459,0.01498459);
   grae->SetPoint(4,0.725,1);
   grae->SetPointError(4,0.02500001,0.02500001,0.02665688,0.02665688);
   grae->SetPoint(5,0.775,1);
   grae->SetPointError(5,0.02500001,0.02500001,0.03060324,0.03060324);
   grae->SetPoint(6,0.825,1);
   grae->SetPointError(6,0.02500001,0.02500001,0.008481732,0.008481732);
   grae->SetPoint(7,0.875,1);
   grae->SetPointError(7,0.02499998,0.02499998,0.007541394,0.007541394);
   grae->SetPoint(8,0.925,1);
   grae->SetPointError(8,0.02500001,0.02500001,0.02678745,0.02678745);
   grae->SetPoint(9,0.975,1);
   grae->SetPointError(9,0.02500001,0.02500001,0.02769066,0.02769066);
   grae->SetPoint(10,1.1,1);
   grae->SetPointError(10,0.1,0.1,0.02540613,0.02540613);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal9_cat0",11, xAxis6);
