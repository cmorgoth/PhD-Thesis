...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.2094498,0.90522);
   grae->SetPoint(1,0.6125,39.56873);
   grae->SetPointError(1,0.03749999,0.03749999,0.8174858,1.112892);
   grae->SetPoint(2,0.7,46.42451);
   grae->SetPointError(2,0.05000001,0.05000001,0.5559921,0.602562);
   grae->SetPoint(3,0.8,47.30774);
   grae->SetPointError(3,0.05000001,0.05000001,0.5676956,1.632977);
   grae->SetPoint(4,0.9,48.85479);
   grae->SetPointError(4,0.04999998,0.04999998,1.813354,0.5043411);
   grae->SetPoint(5,1.075,47.37139);
   grae->SetPointError(5,0.125,0.125,0.3415794,0.08962631);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.3541745);
   Graph_Graph5->SetMaximum(71.05708);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal23_cat1",6, xAxis3);
   h2clone__3->SetBinContent(1,35.41745);
   h2clone__3->SetBinContent(2,39.56873);
   h2clone__3->SetBinContent(3,46.42451);
   h2clone__3->SetBinContent(4,47.30774);
   h2clone__3->SetBinContent(5,48.85479);
   h2clone__3->SetBinContent(6,47.37139);
   h2clone__3->SetEntries(1662);
   ...
   Graph_Graph_Graph56->SetMinimum(0.3541745);
   Graph_Graph_Graph56->SetMaximum(71.05708);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.005913745,0.02555859);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.0206599,0.02812555);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.01197626,0.01297939);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.01200006,0.03451817);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.03711723,0.01032327);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.00721067,0.001891993);
   ...
   TH1F *h4clone__4 = new TH1F("h4clone__4","signal23_cat1",6, xAxis4);
