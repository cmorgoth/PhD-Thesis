...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPoint(0,0.55,101.9565);
   grae->SetPointError(0,0.05000001,0.05000001,1.528229,1.528229);
   grae->SetPoint(1,0.65,53.01465);
   grae->SetPointError(1,0.04999998,0.04999998,0.7896709,0.7896709);
   grae->SetPoint(2,0.825,75.93895);
   grae->SetPointError(2,0.125,0.125,0.1774063,0.1774063);
   grae->SetPoint(3,1.075,9.937824);
   grae->SetPointError(3,0.125,0.125,0.01812792,0.01812792);
