...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,149.1601,1.2875,3376.141);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_2mu_Box->SetBinContent(1,2348.802);
   Data_cat1_1D_2mu_Box->SetBinContent(2,1772.972);
   Data_cat1_1D_2mu_Box->SetBinContent(3,1519.881);
   Data_cat1_1D_2mu_Box->SetBinContent(4,1246.98);
   Data_cat1_1D_2mu_Box->SetBinContent(5,1125.186);
   Data_cat1_1D_2mu_Box->SetBinContent(6,1114.664);
   Data_cat1_1D_2mu_Box->SetBinContent(7,939.1082);
   Data_cat1_1D_2mu_Box->SetBinContent(8,918.451);
   Data_cat1_1D_2mu_Box->SetBinContent(9,698.8475);
   Data_cat1_1D_2mu_Box->SetBinContent(10,509.2746);
   Data_cat1_1D_2mu_Box->SetBinContent(11,780.8508);
   Data_cat1_1D_2mu_Box->SetBinError(1,458.4261);
   Data_cat1_1D_2mu_Box->SetBinError(2,338.5478);
   Data_cat1_1D_2mu_Box->SetBinError(3,162.0151);
   Data_cat1_1D_2mu_Box->SetBinError(4,122.861);
   Data_cat1_1D_2mu_Box->SetBinError(5,80.57189);
   Data_cat1_1D_2mu_Box->SetBinError(6,91.57953);
   Data_cat1_1D_2mu_Box->SetBinError(7,114.2603);
   Data_cat1_1D_2mu_Box->SetBinError(8,166.2586);
   Data_cat1_1D_2mu_Box->SetBinError(9,104.4737);
   Data_cat1_1D_2mu_Box->SetBinError(10,116.3903);
   Data_cat1_1D_2mu_Box->SetBinError(11,39.5794);
   Data_cat1_1D_2mu_Box->SetMinimum(149.1601);
   Data_cat1_1D_2mu_Box->SetMaximum(3053.443);
   Data_cat1_1D_2mu_Box->SetEntries(12561.8);
   ...
   h1clone->SetBinContent(1,2348.802);
   h1clone->SetBinContent(2,1772.972);
   h1clone->SetBinContent(3,1519.881);
   h1clone->SetBinContent(4,1246.98);
   h1clone->SetBinContent(5,1125.186);
   h1clone->SetBinContent(6,1114.664);
   h1clone->SetBinContent(7,939.1082);
   h1clone->SetBinContent(8,918.451);
   h1clone->SetBinContent(9,698.8475);
   h1clone->SetBinContent(10,509.2746);
   h1clone->SetBinContent(11,780.8508);
   h1clone->SetBinError(1,458.4261);
   h1clone->SetBinError(2,338.5478);
   h1clone->SetBinError(3,162.0151);
   h1clone->SetBinError(4,122.861);
   h1clone->SetBinError(5,80.57189);
   h1clone->SetBinError(6,91.57953);
   h1clone->SetBinError(7,114.2603);
   h1clone->SetBinError(8,166.2586);
   h1clone->SetBinError(9,104.4737);
   h1clone->SetBinError(10,116.3903);
   h1clone->SetBinError(11,39.5794);
   h1clone->SetEntries(12561.8);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat1_1D_2mu_Box","R^{2} Bkg Pred. JES Up","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.003948);
   RATIO->SetBinContent(2,0.9967615);
   RATIO->SetBinContent(3,1.007073);
   RATIO->SetBinContent(4,0.997474);
   RATIO->SetBinContent(5,1.003823);
   RATIO->SetBinContent(6,1.002564);
   RATIO->SetBinContent(7,0.9933813);
   RATIO->SetBinContent(8,1.000032);
   RATIO->SetBinContent(9,1.005308);
   RATIO->SetBinContent(10,0.986468);
   RATIO->SetBinContent(11,0.9947321);
   RATIO->SetBinError(1,0.1959449);
   RATIO->SetBinError(2,0.190331);
   RATIO->SetBinError(3,0.1073512);
   RATIO->SetBinError(4,0.09827801);
   RATIO->SetBinError(5,0.07188139);
   RATIO->SetBinError(6,0.0823695);
   RATIO->SetBinError(7,0.1208636);
   RATIO->SetBinError(8,0.1810264);
   RATIO->SetBinError(9,0.1502878);
   RATIO->SetBinError(10,0.2254487);
   RATIO->SetBinError(11,0.05042051);
