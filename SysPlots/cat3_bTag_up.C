...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,12.3996,1.2875,855.9544);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_2mu_Box->SetBinContent(1,593.5377);
   Data_cat3_1D_2mu_Box->SetBinContent(2,335.2231);
   Data_cat3_1D_2mu_Box->SetBinContent(3,285.9472);
   Data_cat3_1D_2mu_Box->SetBinContent(4,233.5544);
   Data_cat3_1D_2mu_Box->SetBinContent(5,171.0407);
   Data_cat3_1D_2mu_Box->SetBinContent(6,80.96783);
   Data_cat3_1D_2mu_Box->SetBinError(1,420.8828);
   Data_cat3_1D_2mu_Box->SetBinError(2,444.1951);
   Data_cat3_1D_2mu_Box->SetBinError(3,73.56596);
   Data_cat3_1D_2mu_Box->SetBinError(4,53.27807);
   Data_cat3_1D_2mu_Box->SetBinError(5,515.9064);
   Data_cat3_1D_2mu_Box->SetBinError(6,21.03967);
   Data_cat3_1D_2mu_Box->SetMinimum(12.3996);
   Data_cat3_1D_2mu_Box->SetMaximum(771.599);
   Data_cat3_1D_2mu_Box->SetEntries(1707.002);
   ...
   h1clone->SetBinContent(1,593.5377);
   h1clone->SetBinContent(2,335.2231);
   h1clone->SetBinContent(3,285.9472);
   h1clone->SetBinContent(4,233.5544);
   h1clone->SetBinContent(5,171.0407);
   h1clone->SetBinContent(6,80.96783);
   h1clone->SetBinError(1,420.8828);
   h1clone->SetBinError(2,444.1951);
   h1clone->SetBinError(3,73.56596);
   h1clone->SetBinError(4,53.27807);
   h1clone->SetBinError(5,515.9064);
   h1clone->SetBinError(6,21.03967);
   h1clone->SetEntries(1707.002);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat3_1D_2mu_Box","R^{2} Bkg Pred. bTag Up","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.010224);
   RATIO->SetBinContent(2,1.031361);
   RATIO->SetBinContent(3,1.023609);
   RATIO->SetBinContent(4,0.9857916);
   RATIO->SetBinContent(5,1.010037);
   RATIO->SetBinContent(6,1.022487);
   RATIO->SetBinError(1,0.7163585);
   RATIO->SetBinError(2,1.366629);
   RATIO->SetBinError(3,0.2633451);
   RATIO->SetBinError(4,0.2248773);
   RATIO->SetBinError(5,3.046552);
   RATIO->SetBinError(6,0.2656956);
