...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPoint(0,0.55,102.9487);
   grae->SetPointError(0,0.05000001,0.05000001,1.082603,1.082603);
   grae->SetPoint(1,0.65,52.09519);
   grae->SetPointError(1,0.04999998,0.04999998,0.5815983,0.5815983);
   grae->SetPoint(2,0.825,76.10191);
   grae->SetPointError(2,0.125,0.125,0.748539,0.748539);
   grae->SetPoint(3,1.075,9.89858);
   grae->SetPointError(3,0.125,0.125,0.06951141,0.06951141);
