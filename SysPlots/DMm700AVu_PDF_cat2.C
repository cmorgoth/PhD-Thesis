...
//=========  (Sat Jul 12 15:48:24 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,0.3896343,1.291,89.05131);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.5375,38.96343);
   grae->SetPointError(0,0.03749999,0.03749999,1.054726,1.054726);
   grae->SetPoint(1,0.6125,36.15475);
   grae->SetPointError(1,0.03749999,0.03749999,0.1793823,0.1793823);
   grae->SetPoint(2,0.7,47.98749);
   grae->SetPointError(2,0.05000001,0.05000001,1.226864,1.226864);
   grae->SetPoint(3,0.8,51.19731);
   grae->SetPointError(3,0.05000001,0.05000001,0.2508774,0.2508774);
   grae->SetPoint(4,0.9,51.432);
   grae->SetPointError(4,0.04999998,0.04999998,0.9551849,0.9551849);
   grae->SetPoint(5,1.075,53.45676);
   grae->SetPointError(5,0.125,0.125,0.6066093,0.6066093);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.3896343);
   Graph_Graph9->SetMaximum(80.18515);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal21_cat1",6, xAxis5);
   h2clone__5->SetBinContent(1,38.96343);
   h2clone__5->SetBinContent(2,36.15475);
   h2clone__5->SetBinContent(3,47.98749);
   h2clone__5->SetBinContent(4,51.19731);
   h2clone__5->SetBinContent(5,51.432);
   h2clone__5->SetBinContent(6,53.45676);
   h2clone__5->SetEntries(1735);
   ...
   Graph_Graph_Graph910->SetMinimum(0.3896343);
   Graph_Graph_Graph910->SetMaximum(80.18515);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.02706963,0.02706963);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.004961514,0.004961514);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.02556633,0.02556633);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.004900206,0.004900206);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.0185718,0.0185718);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.01134766,0.01134766);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal21_cat1",6, xAxis6);
