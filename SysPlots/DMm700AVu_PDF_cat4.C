...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,1.489841,1.489841);
   grae->SetPoint(1,0.65,29.90467);
   grae->SetPointError(1,0.04999998,0.04999998,1.769861,1.769861);
   grae->SetPoint(2,0.825,65.39967);
   grae->SetPointError(2,0.125,0.125,2.680264,2.680267);
   grae->SetPoint(3,1.075,18.06748);
   grae->SetPointError(3,0.125,0.125,0.8514824,0.8514824);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.1806748);
   Graph_Graph9->SetMaximum(98.09951);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal21_cat3",4, xAxis5);
   h2clone__5->SetBinContent(1,40.68047);
   h2clone__5->SetBinContent(2,29.90467);
   h2clone__5->SetBinContent(3,65.39967);
   h2clone__5->SetBinContent(4,18.06748);
   h2clone__5->SetEntries(1081);
   ...
   Graph_Graph_Graph910->SetMinimum(0.1806748);
   Graph_Graph_Graph910->SetMaximum(98.09951);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.03662301,0.03662301);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.05918344,0.05918344);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.04098283,0.04098289);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.0471279,0.0471279);
