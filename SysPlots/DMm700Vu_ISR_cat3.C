...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,8.055374,6.754055);
   grae->SetPoint(1,0.6125,33.49949);
   grae->SetPointError(1,0.03749999,0.03749999,5.955584,4.993511);
   grae->SetPoint(2,0.7,46.40976);
   grae->SetPointError(2,0.05000001,0.05000001,8.250832,6.917881);
   grae->SetPoint(3,0.8,40.10632);
   grae->SetPointError(3,0.05000001,0.05000001,7.13018,5.978283);
   grae->SetPoint(4,0.9,38.83153);
   grae->SetPointError(4,0.04999998,0.04999998,6.903542,5.788258);
   grae->SetPoint(5,1.075,39.69516);
   grae->SetPointError(5,0.125,0.125,7.057068,5.916996);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.4556787);
   Graph_Graph1->SetMaximum(59.54274);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal23_cat2",6, xAxis1);
   h2clone__1->SetBinContent(1,45.56787);
   h2clone__1->SetBinContent(2,33.49949);
   h2clone__1->SetBinContent(3,46.40976);
   h2clone__1->SetBinContent(4,40.10632);
   h2clone__1->SetBinContent(5,38.83153);
   h2clone__1->SetBinContent(6,39.69516);
   h2clone__1->SetEntries(1775);
   ...
   Graph_Graph_Graph12->SetMinimum(0.4556787);
   Graph_Graph_Graph12->SetMaximum(59.54274);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.1767775,0.1482197);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1777813,0.1490623);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1777822,0.1490609);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.177782,0.1490609);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1777819,0.1490608);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.1777816,0.1490609);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal23_cat2",6, xAxis2);
