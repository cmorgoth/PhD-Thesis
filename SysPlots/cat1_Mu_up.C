...
//=========  (Mon Jun  2 19:14:04 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,149.1601,1.2875,3358.962);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_2mu_Box->SetBinContent(1,2336.909);
   Data_cat1_1D_2mu_Box->SetBinContent(2,1776.635);
   Data_cat1_1D_2mu_Box->SetBinContent(3,1507.422);
   Data_cat1_1D_2mu_Box->SetBinContent(4,1248.672);
   Data_cat1_1D_2mu_Box->SetBinContent(5,1119.607);
   Data_cat1_1D_2mu_Box->SetBinContent(6,1110.469);
   Data_cat1_1D_2mu_Box->SetBinContent(7,944.2821);
   Data_cat1_1D_2mu_Box->SetBinContent(8,917.348);
   Data_cat1_1D_2mu_Box->SetBinContent(9,694.3367);
   Data_cat1_1D_2mu_Box->SetBinContent(10,515.6487);
   Data_cat1_1D_2mu_Box->SetBinContent(11,784.0717);
   Data_cat1_1D_2mu_Box->SetBinError(1,445.4718);
   Data_cat1_1D_2mu_Box->SetBinError(2,397.8159);
   Data_cat1_1D_2mu_Box->SetBinError(3,151.4525);
   Data_cat1_1D_2mu_Box->SetBinError(4,127.0304);
   Data_cat1_1D_2mu_Box->SetBinError(5,78.14564);
   Data_cat1_1D_2mu_Box->SetBinError(6,88.97554);
   Data_cat1_1D_2mu_Box->SetBinError(7,122.5465);
   Data_cat1_1D_2mu_Box->SetBinError(8,163.9889);
   Data_cat1_1D_2mu_Box->SetBinError(9,104.9681);
   Data_cat1_1D_2mu_Box->SetBinError(10,122.3241);
   Data_cat1_1D_2mu_Box->SetBinError(11,39.13363);
   Data_cat1_1D_2mu_Box->SetMinimum(149.1601);
   Data_cat1_1D_2mu_Box->SetMaximum(3037.982);
   Data_cat1_1D_2mu_Box->SetEntries(12424.35);
   ...
   h1clone->SetBinContent(1,2336.909);
   h1clone->SetBinContent(2,1776.635);
   h1clone->SetBinContent(3,1507.422);
   h1clone->SetBinContent(4,1248.672);
   h1clone->SetBinContent(5,1119.607);
   h1clone->SetBinContent(6,1110.469);
   h1clone->SetBinContent(7,944.2821);
   h1clone->SetBinContent(8,917.348);
   h1clone->SetBinContent(9,694.3367);
   h1clone->SetBinContent(10,515.6487);
   h1clone->SetBinContent(11,784.0717);
   h1clone->SetBinError(1,445.4718);
   h1clone->SetBinError(2,397.8159);
   h1clone->SetBinError(3,151.4525);
   h1clone->SetBinError(4,127.0304);
   h1clone->SetBinError(5,78.14564);
   h1clone->SetBinError(6,88.97554);
   h1clone->SetBinError(7,122.5465);
   h1clone->SetBinError(8,163.9889);
   h1clone->SetBinError(9,104.9681);
   h1clone->SetBinError(10,122.3241);
   h1clone->SetBinError(11,39.13363);
   h1clone->SetEntries(12424.35);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat1_1D_2mu_Box","R^{2} Bkg Pred. Mu up","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.998864);
   RATIO->SetBinContent(2,0.9988211);
   RATIO->SetBinContent(3,0.998818);
   RATIO->SetBinContent(4,0.9988279);
   RATIO->SetBinContent(5,0.9988462);
   RATIO->SetBinContent(6,0.9987907);
   RATIO->SetBinContent(7,0.9988542);
   RATIO->SetBinContent(8,0.9988306);
   RATIO->SetBinContent(9,0.9988191);
   RATIO->SetBinContent(10,0.9988146);
   RATIO->SetBinContent(11,0.9988352);
   RATIO->SetBinError(1,0.1904078);
   RATIO->SetBinError(2,0.2236514);
   RATIO->SetBinError(3,0.1003525);
   RATIO->SetBinError(4,0.1016131);
   RATIO->SetBinError(5,0.06971684);
   RATIO->SetBinError(6,0.08002739);
   RATIO->SetBinError(7,0.1296287);
   RATIO->SetBinError(8,0.1785551);
   RATIO->SetBinError(9,0.150999);
   RATIO->SetBinError(10,0.2369425);
   RATIO->SetBinError(11,0.04985264);
