...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,7.213554,6.042049);
   grae->SetPoint(1,0.65,29.90467);
   grae->SetPointError(1,0.04999998,0.04999998,5.30278,4.441549);
   grae->SetPoint(2,0.825,65.39967);
   grae->SetPointError(2,0.125,0.125,11.59681,9.713348);
   grae->SetPoint(3,1.075,18.06748);
   grae->SetPointError(3,0.125,0.125,3.203766,2.683451);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.1806748);
   Graph_Graph1->SetMaximum(98.09951);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal21_cat3",4, xAxis1);
   h2clone__1->SetBinContent(1,40.68047);
   h2clone__1->SetBinContent(2,29.90467);
   h2clone__1->SetBinContent(3,65.39967);
   h2clone__1->SetBinContent(4,18.06748);
   h2clone__1->SetEntries(1081);
   ...
   Graph_Graph_Graph12->SetMinimum(0.1806748);
   Graph_Graph_Graph12->SetMaximum(98.09951);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.1773223,0.1485246);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.1773228,0.1485236);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.1773221,0.1485229);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.1773222,0.1485238);
