...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,149.1601,1.2875,3322.267);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_2mu_Box->SetBinContent(1,2311.505);
   Data_cat1_1D_2mu_Box->SetBinContent(2,1792.091);
   Data_cat1_1D_2mu_Box->SetBinContent(3,1496.935);
   Data_cat1_1D_2mu_Box->SetBinContent(4,1253.822);
   Data_cat1_1D_2mu_Box->SetBinContent(5,1125.084);
   Data_cat1_1D_2mu_Box->SetBinContent(6,1111.122);
   Data_cat1_1D_2mu_Box->SetBinContent(7,938.601);
   Data_cat1_1D_2mu_Box->SetBinContent(8,903.8922);
   Data_cat1_1D_2mu_Box->SetBinContent(9,704.5307);
   Data_cat1_1D_2mu_Box->SetBinContent(10,514.9401);
   Data_cat1_1D_2mu_Box->SetBinContent(11,783.2849);
   Data_cat1_1D_2mu_Box->SetBinError(1,448.1258);
   Data_cat1_1D_2mu_Box->SetBinError(2,396.2417);
   Data_cat1_1D_2mu_Box->SetBinError(3,156.3344);
   Data_cat1_1D_2mu_Box->SetBinError(4,131.4558);
   Data_cat1_1D_2mu_Box->SetBinError(5,79.51479);
   Data_cat1_1D_2mu_Box->SetBinError(6,86.25836);
   Data_cat1_1D_2mu_Box->SetBinError(7,123.6813);
   Data_cat1_1D_2mu_Box->SetBinError(8,153.536);
   Data_cat1_1D_2mu_Box->SetBinError(9,99.73835);
   Data_cat1_1D_2mu_Box->SetBinError(10,129.3417);
   Data_cat1_1D_2mu_Box->SetBinError(11,39.01526);
   Data_cat1_1D_2mu_Box->SetMinimum(149.1601);
   Data_cat1_1D_2mu_Box->SetMaximum(3004.956);
   Data_cat1_1D_2mu_Box->SetEntries(12320.6);
   ...
   h1clone->SetBinContent(1,2311.505);
   h1clone->SetBinContent(2,1792.091);
   h1clone->SetBinContent(3,1496.935);
   h1clone->SetBinContent(4,1253.822);
   h1clone->SetBinContent(5,1125.084);
   h1clone->SetBinContent(6,1111.122);
   h1clone->SetBinContent(7,938.601);
   h1clone->SetBinContent(8,903.8922);
   h1clone->SetBinContent(9,704.5307);
   h1clone->SetBinContent(10,514.9401);
   h1clone->SetBinContent(11,783.2849);
   h1clone->SetBinError(1,448.1258);
   h1clone->SetBinError(2,396.2417);
   h1clone->SetBinError(3,156.3344);
   h1clone->SetBinError(4,131.4558);
   h1clone->SetBinError(5,79.51479);
   h1clone->SetBinError(6,86.25836);
   h1clone->SetBinError(7,123.6813);
   h1clone->SetBinError(8,153.536);
   h1clone->SetBinError(9,99.73835);
   h1clone->SetBinError(10,129.3417);
   h1clone->SetBinError(11,39.01526);
   h1clone->SetEntries(12320.6);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat1_1D_2mu_Box","R^{2} Bkg Pred. JES Down","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9880056);
   RATIO->SetBinContent(2,1.00751);
   RATIO->SetBinContent(3,0.9918694);
   RATIO->SetBinContent(4,1.002947);
   RATIO->SetBinContent(5,1.003733);
   RATIO->SetBinContent(6,0.9993781);
   RATIO->SetBinContent(7,0.9928448);
   RATIO->SetBinContent(8,0.9841797);
   RATIO->SetBinContent(9,1.013483);
   RATIO->SetBinContent(10,0.9974419);
   RATIO->SetBinContent(11,0.9978328);
   RATIO->SetBinError(1,0.1915422);
   RATIO->SetBinError(2,0.2227664);
   RATIO->SetBinError(3,0.1035872);
   RATIO->SetBinError(4,0.105153);
   RATIO->SetBinError(5,0.07093831);
   RATIO->SetBinError(6,0.07758347);
   RATIO->SetBinError(7,0.1308291);
   RATIO->SetBinError(8,0.1671737);
   RATIO->SetBinError(9,0.1434759);
   RATIO->SetBinError(10,0.2505356);
   RATIO->SetBinError(11,0.04970185);
