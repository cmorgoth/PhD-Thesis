...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,2.239613,1.23349);
   grae->SetPoint(1,0.6125,37.06154);
   grae->SetPointError(1,0.03749999,0.03749999,1.653572,0.03342056);
   grae->SetPoint(2,0.7,46.39066);
   grae->SetPointError(2,0.05000001,0.05000001,0.7746658,0.3826218);
   grae->SetPoint(3,0.8,46.17154);
   grae->SetPointError(3,0.05000001,0.05000001,0.870182,0.7112694);
   grae->SetPoint(4,0.9,42.06592);
   grae->SetPointError(4,0.04999998,0.04999998,0.4293098,1.161938);
   grae->SetPoint(5,1.075,43.97582);
   grae->SetPointError(5,0.125,0.125,0.5580254,0.239418);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.4991851);
   Graph_Graph5->SetMaximum(65.96373);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal21_cat2",6, xAxis3);
   h2clone__3->SetBinContent(1,49.91851);
   h2clone__3->SetBinContent(2,37.06154);
   h2clone__3->SetBinContent(3,46.39066);
   h2clone__3->SetBinContent(4,46.17154);
   h2clone__3->SetBinContent(5,42.06592);
   h2clone__3->SetBinContent(6,43.97582);
   h2clone__3->SetEntries(1887);
   ...
   Graph_Graph_Graph56->SetMinimum(0.4991851);
   Graph_Graph_Graph56->SetMaximum(65.96373);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.04486537,0.02471007);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.04461693,0.0009017585);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.01669875,0.00824782);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.01884672,0.01540493);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.01020564,0.02762183);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.01268937,0.005444311);
   ...
   TH1F *h4clone__4 = new TH1F("h4clone__4","signal21_cat2",6, xAxis4);
