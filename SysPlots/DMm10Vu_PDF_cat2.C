...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.7127075,0.7127075);
   grae->SetPoint(1,0.6125,26.8599);
   grae->SetPointError(1,0.03749999,0.03749999,0.4706554,0.4706554);
   grae->SetPoint(2,0.7,34.07595);
   grae->SetPointError(2,0.05000001,0.05000001,1.150871,1.150871);
   grae->SetPoint(3,0.8,34.16554);
   grae->SetPointError(3,0.05000001,0.05000001,1.461422,1.461422);
   grae->SetPoint(4,0.9,32.31069);
   grae->SetPointError(4,0.04999998,0.04999998,1.516916,1.516918);
   grae->SetPoint(5,1.075,34.48091);
   grae->SetPointError(5,0.125,0.125,1.29903,1.29903);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.3027753);
   Graph_Graph9->SetMaximum(51.72136);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal11_cat1",6, xAxis5);
   h2clone__5->SetBinContent(1,30.27753);
   h2clone__5->SetBinContent(2,26.8599);
   h2clone__5->SetBinContent(3,34.07595);
   h2clone__5->SetBinContent(4,34.16554);
   h2clone__5->SetBinContent(5,32.31069);
   h2clone__5->SetBinContent(6,34.48091);
   h2clone__5->SetEntries(1193);
   ...
   Graph_Graph_Graph910->SetMinimum(0.3027753);
   Graph_Graph_Graph910->SetMaximum(51.72136);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.02353915,0.02353915);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.01752261,0.01752261);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.03377371,0.03377371);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.04277473,0.04277473);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.04694782,0.04694788);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.0376739,0.0376739);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal11_cat1",6, xAxis6);
