...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,12.3996,1.2875,832.7139);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_2mu_Box->SetBinContent(1,577.4481);
   Data_cat3_1D_2mu_Box->SetBinContent(2,325.4994);
   Data_cat3_1D_2mu_Box->SetBinContent(3,279.6984);
   Data_cat3_1D_2mu_Box->SetBinContent(4,234.4783);
   Data_cat3_1D_2mu_Box->SetBinContent(5,170.3891);
   Data_cat3_1D_2mu_Box->SetBinContent(6,78.6659);
   Data_cat3_1D_2mu_Box->SetBinError(1,391.2153);
   Data_cat3_1D_2mu_Box->SetBinError(2,414.0826);
   Data_cat3_1D_2mu_Box->SetBinError(3,65.32734);
   Data_cat3_1D_2mu_Box->SetBinError(4,61.6769);
   Data_cat3_1D_2mu_Box->SetBinError(5,481.6651);
   Data_cat3_1D_2mu_Box->SetBinError(6,18.22823);
   Data_cat3_1D_2mu_Box->SetMinimum(12.3996);
   Data_cat3_1D_2mu_Box->SetMaximum(750.6825);
   Data_cat3_1D_2mu_Box->SetEntries(1741.239);
   ...
   h1clone->SetBinContent(1,577.4481);
   h1clone->SetBinContent(2,325.4994);
   h1clone->SetBinContent(3,279.6984);
   h1clone->SetBinContent(4,234.4783);
   h1clone->SetBinContent(5,170.3891);
   h1clone->SetBinContent(6,78.6659);
   h1clone->SetBinError(1,391.2153);
   h1clone->SetBinError(2,414.0826);
   h1clone->SetBinError(3,65.32734);
   h1clone->SetBinError(4,61.6769);
   h1clone->SetBinError(5,481.6651);
   h1clone->SetBinError(6,18.22823);
   h1clone->SetEntries(1741.239);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat3_1D_2mu_Box","R^{2} Bkg Pred. JES Up","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.9828385);
   RATIO->SetBinContent(2,1.001445);
   RATIO->SetBinContent(3,1.00124);
   RATIO->SetBinContent(4,0.9896915);
   RATIO->SetBinContent(5,1.006189);
   RATIO->SetBinContent(6,0.9934178);
   RATIO->SetBinError(1,0.6658632);
   RATIO->SetBinError(2,1.273984);
   RATIO->SetBinError(3,0.2338532);
   RATIO->SetBinError(4,0.2603273);
   RATIO->SetBinError(5,2.844349);
   RATIO->SetBinError(6,0.2301918);
