...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,3.362661,2.918911);
   grae->SetPoint(1,0.6125,26.8599);
   grae->SetPointError(1,0.03749999,0.03749999,4.222448,3.665243);
   grae->SetPoint(2,0.7,34.07595);
   grae->SetPointError(2,0.05000001,0.05000001,6.047449,5.24942);
   grae->SetPoint(3,0.8,34.16554);
   grae->SetPointError(3,0.05000001,0.05000001,6.444569,5.594154);
   grae->SetPoint(4,0.9,32.31069);
   grae->SetPointError(4,0.04999998,0.04999998,6.217798,5.397297);
   grae->SetPoint(5,1.075,34.48091);
   grae->SetPointError(5,0.125,0.125,6.654541,5.776409);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.3027753);
   Graph_Graph1->SetMaximum(51.72136);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal11_cat1",6, xAxis1);
   h2clone__1->SetBinContent(1,30.27753);
   h2clone__1->SetBinContent(2,26.8599);
   h2clone__1->SetBinContent(3,34.07595);
   h2clone__1->SetBinContent(4,34.16554);
   h2clone__1->SetBinContent(5,32.31069);
   h2clone__1->SetBinContent(6,34.48091);
   h2clone__1->SetEntries(1193);
   ...
   Graph_Graph_Graph12->SetMinimum(0.3027753);
   Graph_Graph_Graph12->SetMaximum(51.72136);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.1110613,0.09640517);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1572027,0.1364578);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1774697,0.1540506);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.1886277,0.1637367);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1924378,0.1670437);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.1929921,0.1675249);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal11_cat1",6, xAxis2);
