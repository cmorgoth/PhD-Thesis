...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,1.286404,1.286404);
   grae->SetPoint(1,0.6125,39.56873);
   grae->SetPointError(1,0.03749999,0.03749999,1.207741,1.207741);
   grae->SetPoint(2,0.7,46.42451);
   grae->SetPointError(2,0.05000001,0.05000001,1.396061,1.396061);
   grae->SetPoint(3,0.8,47.30774);
   grae->SetPointError(3,0.05000001,0.05000001,1.591358,1.591358);
   grae->SetPoint(4,0.9,48.85479);
   grae->SetPointError(4,0.04999998,0.04999998,1.097256,1.097256);
   grae->SetPoint(5,1.075,47.37139);
   grae->SetPointError(5,0.125,0.125,0.7888756,0.7888756);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.3541745);
   Graph_Graph9->SetMaximum(71.05708);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal23_cat1",6, xAxis5);
   h2clone__5->SetBinContent(1,35.41745);
   h2clone__5->SetBinContent(2,39.56873);
   h2clone__5->SetBinContent(3,46.42451);
   h2clone__5->SetBinContent(4,47.30774);
   h2clone__5->SetBinContent(5,48.85479);
   h2clone__5->SetBinContent(6,47.37139);
   h2clone__5->SetEntries(1662);
   ...
   Graph_Graph_Graph910->SetMinimum(0.3541745);
   Graph_Graph_Graph910->SetMaximum(71.05708);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.03632118,0.03632118);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.03052261,0.03052261);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.03007163,0.03007163);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.03363843,0.03363843);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.02245953,0.02245953);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.016653,0.016653);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal23_cat1",6, xAxis6);
