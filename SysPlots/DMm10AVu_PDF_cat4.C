...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,1.296022,1.296022);
   grae->SetPoint(1,0.65,13.38194);
   grae->SetPointError(1,0.04999998,0.04999998,0.9627771,0.9627771);
   grae->SetPoint(2,0.825,26.72165);
   grae->SetPointError(2,0.125,0.125,1.809034,1.809034);
   grae->SetPoint(3,1.075,5.843966);
   grae->SetPointError(3,0.125,0.125,0.6575894,0.6575894);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.05843966);
   Graph_Graph9->SetMaximum(40.08248);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal9_cat3",4, xAxis5);
   h2clone__5->SetBinContent(1,23.77528);
   h2clone__5->SetBinContent(2,13.38194);
   h2clone__5->SetBinContent(3,26.72165);
   h2clone__5->SetBinContent(4,5.843966);
   h2clone__5->SetEntries(630);
   ...
   Graph_Graph_Graph910->SetMinimum(0.05843966);
   Graph_Graph_Graph910->SetMaximum(40.08248);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.05451134,0.05451134);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.07194599,0.07194599);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.06769919,0.06769919);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.1125245,0.1125245);
