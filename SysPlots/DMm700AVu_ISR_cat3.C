...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,8.806602,7.376343);
   grae->SetPoint(1,0.6125,37.06154);
   grae->SetPointError(1,0.03749999,0.03749999,6.57185,5.50452);
   grae->SetPoint(2,0.7,46.39066);
   grae->SetPointError(2,0.05000001,0.05000001,8.22612,6.890121);
   grae->SetPoint(3,0.8,46.17154);
   grae->SetPointError(3,0.05000001,0.05000001,8.187263,6.857578);
   grae->SetPoint(4,0.9,42.06592);
   grae->SetPointError(4,0.04999998,0.04999998,7.459263,6.247784);
   grae->SetPoint(5,1.075,43.97582);
   grae->SetPointError(5,0.125,0.125,7.79792,6.531422);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.4991851);
   Graph_Graph1->SetMaximum(65.96373);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal21_cat2",6, xAxis1);
   h2clone__1->SetBinContent(1,49.91851);
   h2clone__1->SetBinContent(2,37.06154);
   h2clone__1->SetBinContent(3,46.39066);
   h2clone__1->SetBinContent(4,46.17154);
   h2clone__1->SetBinContent(5,42.06592);
   h2clone__1->SetBinContent(6,43.97582);
   h2clone__1->SetEntries(1887);
   ...
   Graph_Graph_Graph12->SetMinimum(0.4991851);
   Graph_Graph_Graph12->SetMaximum(65.96373);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.1764196,0.1477677);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1773226,0.1485238);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1773228,0.1485239);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.1773227,0.1485239);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1773232,0.1485236);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.1773229,0.148523);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal21_cat2",6, xAxis2);
