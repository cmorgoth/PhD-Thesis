...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,5.53651,4.805908);
   grae->SetPoint(1,0.6125,24.2545);
   grae->SetPointError(1,0.03749999,0.03749999,4.680933,4.063213);
   grae->SetPoint(2,0.7,27.86115);
   grae->SetPointError(2,0.05000001,0.05000001,5.376987,4.667446);
   grae->SetPoint(3,0.8,24.9127);
   grae->SetPointError(3,0.05000001,0.05000001,4.807957,4.173512);
   grae->SetPoint(4,0.9,21.51864);
   grae->SetPointError(4,0.04999998,0.04999998,4.152916,3.604921);
   grae->SetPoint(5,1.075,19.04998);
   grae->SetPointError(5,0.125,0.125,3.676498,3.191355);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.1904998);
   Graph_Graph1->SetMaximum(41.79172);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal11_cat2",6, xAxis1);
   h2clone__1->SetBinContent(1,28.8872);
   h2clone__1->SetBinContent(2,24.2545);
   h2clone__1->SetBinContent(3,27.86115);
   h2clone__1->SetBinContent(4,24.9127);
   h2clone__1->SetBinContent(5,21.51864);
   h2clone__1->SetBinContent(6,19.04998);
   h2clone__1->SetEntries(1061);
   ...
   Graph_Graph_Graph12->SetMinimum(0.1904998);
   Graph_Graph_Graph12->SetMaximum(41.79172);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.1916596,0.1663681);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1929923,0.1675241);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1929923,0.1675253);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.1929922,0.1675254);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1929916,0.1675255);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.1929922,0.1675254);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal11_cat2",6, xAxis2);
