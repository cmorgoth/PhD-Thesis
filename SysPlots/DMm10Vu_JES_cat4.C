...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.2380028,0.6542854);
   grae->SetPoint(1,0.65,15.07168);
   grae->SetPointError(1,0.04999998,0.04999998,0.5529146,0.1286373);
   grae->SetPoint(2,0.825,26.40178);
   grae->SetPointError(2,0.125,0.125,0.4633045,0.1745605);
   grae->SetPoint(3,1.075,6.139977);
   grae->SetPointError(3,0.125,0.125,0.1831656,0);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.06139977);
   Graph_Graph5->SetMaximum(39.60267);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal11_cat3",4, xAxis3);
   h2clone__3->SetBinContent(1,21.76858);
   h2clone__3->SetBinContent(2,15.07168);
   h2clone__3->SetBinContent(3,26.40178);
   h2clone__3->SetBinContent(4,6.139977);
   h2clone__3->SetEntries(500);
   ...
   Graph_Graph_Graph56->SetMinimum(0.06139977);
   Graph_Graph_Graph56->SetMaximum(39.60267);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.01093332,0.03005641);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.03668567,0.008535036);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.01754823,0.006611696);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.02983163,0);
