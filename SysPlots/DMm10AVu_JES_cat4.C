...
//=========  (Sat Jul 12 16:07:51 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,0.05843966,1.291,44.5296);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.55,23.77528);
   grae->SetPointError(0,0.05000001,0.05000001,0.7775326,0.0803833);
   grae->SetPoint(1,0.65,13.38194);
   grae->SetPointError(1,0.04999998,0.04999998,0.01902771,0.4783287);
   grae->SetPoint(2,0.825,26.72165);
   grae->SetPointError(2,0.125,0.125,0.8354073,0.6637669);
   grae->SetPoint(3,1.075,5.843966);
   grae->SetPointError(3,0.125,0.125,0.05460358,0.3422709);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.05843966);
   Graph_Graph5->SetMaximum(40.08248);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal9_cat3",4, xAxis3);
   h2clone__3->SetBinContent(1,23.77528);
   h2clone__3->SetBinContent(2,13.38194);
   h2clone__3->SetBinContent(3,26.72165);
   h2clone__3->SetBinContent(4,5.843966);
   h2clone__3->SetEntries(630);
   ...
   Graph_Graph_Graph56->SetMinimum(0.05843966);
   Graph_Graph_Graph56->SetMaximum(40.08248);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.0327034,0.003380961);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.001421894,0.03574434);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.03126331,0.02484004);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.009343583,0.05856825);
