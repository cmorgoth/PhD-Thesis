...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,4.592518,3.988083);
   grae->SetPoint(1,0.65,13.38194);
   grae->SetPointError(1,0.04999998,0.04999998,2.584906,2.244682);
   grae->SetPoint(2,0.825,26.72165);
   grae->SetPointError(2,0.125,0.125,5.161657,4.482288);
   grae->SetPoint(3,1.075,5.843966);
   grae->SetPointError(3,0.125,0.125,1.128839,0.980268);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.05843966);
   Graph_Graph1->SetMaximum(40.08248);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal9_cat3",4, xAxis1);
   h2clone__1->SetBinContent(1,23.77528);
   h2clone__1->SetBinContent(2,13.38194);
   h2clone__1->SetBinContent(3,26.72165);
   h2clone__1->SetBinContent(4,5.843966);
   h2clone__1->SetEntries(630);
   ...
   Graph_Graph_Graph12->SetMinimum(0.05843966);
   Graph_Graph_Graph12->SetMaximum(40.08248);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.1931635,0.1677407);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.1931637,0.1677396);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.1931638,0.1677399);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.1931633,0.1677402);
