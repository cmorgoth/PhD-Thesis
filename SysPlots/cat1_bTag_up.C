...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,149.1601,1.2875,3383.997);
   pad1->SetFillColor(0);
   ...
   Data_cat1_1D_2mu_Box->SetBinContent(1,2354.241);
   Data_cat1_1D_2mu_Box->SetBinContent(2,1817.458);
   Data_cat1_1D_2mu_Box->SetBinContent(3,1518.301);
   Data_cat1_1D_2mu_Box->SetBinContent(4,1266.64);
   Data_cat1_1D_2mu_Box->SetBinContent(5,1150.599);
   Data_cat1_1D_2mu_Box->SetBinContent(6,1113.978);
   Data_cat1_1D_2mu_Box->SetBinContent(7,962.2935);
   Data_cat1_1D_2mu_Box->SetBinContent(8,939.1862);
   Data_cat1_1D_2mu_Box->SetBinContent(9,705.1863);
   Data_cat1_1D_2mu_Box->SetBinContent(10,534.6749);
   Data_cat1_1D_2mu_Box->SetBinContent(11,801.5182);
   Data_cat1_1D_2mu_Box->SetBinError(1,397.9721);
   Data_cat1_1D_2mu_Box->SetBinError(2,422.9574);
   Data_cat1_1D_2mu_Box->SetBinError(3,181.0409);
   Data_cat1_1D_2mu_Box->SetBinError(4,132.4748);
   Data_cat1_1D_2mu_Box->SetBinError(5,72.9303);
   Data_cat1_1D_2mu_Box->SetBinError(6,89.05456);
   Data_cat1_1D_2mu_Box->SetBinError(7,136.2182);
   Data_cat1_1D_2mu_Box->SetBinError(8,188.1221);
   Data_cat1_1D_2mu_Box->SetBinError(9,96.98734);
   Data_cat1_1D_2mu_Box->SetBinError(10,119.7563);
   Data_cat1_1D_2mu_Box->SetBinError(11,41.29445);
   Data_cat1_1D_2mu_Box->SetMinimum(149.1601);
   Data_cat1_1D_2mu_Box->SetMaximum(3060.513);
   Data_cat1_1D_2mu_Box->SetEntries(12360.83);
   ...
   h1clone->SetBinContent(1,2354.241);
   h1clone->SetBinContent(2,1817.458);
   h1clone->SetBinContent(3,1518.301);
   h1clone->SetBinContent(4,1266.64);
   h1clone->SetBinContent(5,1150.599);
   h1clone->SetBinContent(6,1113.978);
   h1clone->SetBinContent(7,962.2935);
   h1clone->SetBinContent(8,939.1862);
   h1clone->SetBinContent(9,705.1863);
   h1clone->SetBinContent(10,534.6749);
   h1clone->SetBinContent(11,801.5182);
   h1clone->SetBinError(1,397.9721);
   h1clone->SetBinError(2,422.9574);
   h1clone->SetBinError(3,181.0409);
   h1clone->SetBinError(4,132.4748);
   h1clone->SetBinError(5,72.9303);
   h1clone->SetBinError(6,89.05456);
   h1clone->SetBinError(7,136.2182);
   h1clone->SetBinError(8,188.1221);
   h1clone->SetBinError(9,96.98734);
   h1clone->SetBinError(10,119.7563);
   h1clone->SetBinError(11,41.29445);
   h1clone->SetEntries(12360.83);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat1_1D_2mu_Box","R^{2} Bkg Pred. bTag Up","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.006272);
   RATIO->SetBinContent(2,1.021772);
   RATIO->SetBinContent(3,1.006026);
   RATIO->SetBinContent(4,1.013201);
   RATIO->SetBinContent(5,1.026496);
   RATIO->SetBinContent(6,1.001946);
   RATIO->SetBinContent(7,1.017906);
   RATIO->SetBinContent(8,1.022609);
   RATIO->SetBinContent(9,1.014426);
   RATIO->SetBinContent(10,1.035668);
   RATIO->SetBinContent(11,1.02106);
   RATIO->SetBinError(1,0.1701051);
   RATIO->SetBinError(2,0.2377859);
   RATIO->SetBinError(3,0.1199577);
   RATIO->SetBinError(4,0.1059682);
   RATIO->SetBinError(5,0.06506402);
   RATIO->SetBinError(6,0.08009846);
   RATIO->SetBinError(7,0.1440906);
   RATIO->SetBinError(8,0.2048318);
   RATIO->SetBinError(9,0.1395185);
   RATIO->SetBinError(10,0.2319686);
   RATIO->SetBinError(11,0.05260532);
