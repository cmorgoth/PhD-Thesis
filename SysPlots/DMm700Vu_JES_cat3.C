...
//=========  (Sat Jul 12 15:47:02 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,0.4556787,1.291,66.10797);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.5375,45.56787);
   grae->SetPointError(0,0.03749999,0.03749999,0.6924744,0.2027855);
   grae->SetPoint(1,0.6125,33.49949);
   grae->SetPointError(1,0.03749999,0.03749999,0.6921692,0.5011024);
   grae->SetPoint(2,0.7,46.40976);
   grae->SetPointError(2,0.05000001,0.05000001,0.9242859,0.5383415);
   grae->SetPoint(3,0.8,40.10632);
   grae->SetPointError(3,0.05000001,0.05000001,0.9424667,0.3786621);
   grae->SetPoint(4,0.9,38.83153);
   grae->SetPointError(4,0.04999998,0.04999998,0.5752029,2.062321);
   grae->SetPoint(5,1.075,39.69516);
   grae->SetPointError(5,0.125,0.125,0.5845528,0.09778976);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.4556787);
   Graph_Graph5->SetMaximum(59.54274);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal23_cat2",6, xAxis3);
   h2clone__3->SetBinContent(1,45.56787);
   h2clone__3->SetBinContent(2,33.49949);
   h2clone__3->SetBinContent(3,46.40976);
   h2clone__3->SetBinContent(4,40.10632);
   h2clone__3->SetBinContent(5,38.83153);
   h2clone__3->SetBinContent(6,39.69516);
   h2clone__3->SetEntries(1775);
   ...
   Graph_Graph_Graph56->SetMinimum(0.4556787);
   Graph_Graph_Graph56->SetMaximum(59.54274);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.01519655,0.004450186);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.02066208,0.01495851);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.01991576,0.01159975);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.02349921,0.009441458);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.01481278,0.05310944);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.01472605,0.002463519);
   ...
   TH1F *h4clone__4 = new TH1F("h4clone__4","signal23_cat2",6, xAxis4);
