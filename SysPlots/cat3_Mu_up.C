...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.4125,12.3996,1.2875,846.4159);
   pad1->SetFillColor(0);
   ...
   Data_cat3_1D_2mu_Box->SetBinContent(1,586.9341);
   Data_cat3_1D_2mu_Box->SetBinContent(2,324.7277);
   Data_cat3_1D_2mu_Box->SetBinContent(3,279.0927);
   Data_cat3_1D_2mu_Box->SetBinContent(4,236.7012);
   Data_cat3_1D_2mu_Box->SetBinContent(5,169.1794);
   Data_cat3_1D_2mu_Box->SetBinContent(6,79.11336);
   Data_cat3_1D_2mu_Box->SetBinError(1,408.7889);
   Data_cat3_1D_2mu_Box->SetBinError(2,416.138);
   Data_cat3_1D_2mu_Box->SetBinError(3,67.55713);
   Data_cat3_1D_2mu_Box->SetBinError(4,66.01768);
   Data_cat3_1D_2mu_Box->SetBinError(5,502.4592);
   Data_cat3_1D_2mu_Box->SetBinError(6,17.17705);
   Data_cat3_1D_2mu_Box->SetMinimum(12.3996);
   Data_cat3_1D_2mu_Box->SetMaximum(763.0143);
   Data_cat3_1D_2mu_Box->SetEntries(1724.01);
   ...
   h1clone->SetBinContent(1,586.9341);
   h1clone->SetBinContent(2,324.7277);
   h1clone->SetBinContent(3,279.0927);
   h1clone->SetBinContent(4,236.7012);
   h1clone->SetBinContent(5,169.1794);
   h1clone->SetBinContent(6,79.11336);
   h1clone->SetBinError(1,408.7889);
   h1clone->SetBinError(2,416.138);
   h1clone->SetBinError(3,67.55713);
   h1clone->SetBinError(4,66.01768);
   h1clone->SetBinError(5,502.4592);
   h1clone->SetBinError(6,17.17705);
   h1clone->SetEntries(1724.01);
   h1clone->SetStats(0);
   ...
   TLegendEntry *entry=leg->AddEntry("Data_cat3_1D_2mu_Box","R^{2} Bkg Pred. Mu up","l");
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,0.998984);
   RATIO->SetBinContent(2,0.9990706);
   RATIO->SetBinContent(3,0.999072);
   RATIO->SetBinContent(4,0.9990737);
   RATIO->SetBinContent(5,0.9990455);
   RATIO->SetBinContent(6,0.9990684);
   RATIO->SetBinError(1,0.6957743);
   RATIO->SetBinError(2,1.280307);
   RATIO->SetBinError(3,0.2418352);
   RATIO->SetBinError(4,0.2786489);
   RATIO->SetBinError(5,2.967143);
   RATIO->SetBinError(6,0.2169172);
