...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,3.843822,3.219379);
   grae->SetPoint(1,0.6125,36.15475);
   grae->SetPointError(1,0.03749999,0.03749999,5.110949,4.28083);
   grae->SetPoint(2,0.7,47.98749);
   grae->SetPointError(2,0.05000001,0.05000001,7.939671,6.650223);
   grae->SetPoint(3,0.8,51.19731);
   grae->SetPointError(3,0.05000001,0.05000001,8.924248,7.47493);
   grae->SetPoint(4,0.9,51.432);
   grae->SetPointError(4,0.04999998,0.04999998,9.119999,7.638908);
   grae->SetPoint(5,1.075,53.45676);
   grae->SetPointError(5,0.125,0.125,9.479012,7.939671);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.3896343);
   Graph_Graph1->SetMaximum(80.18515);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal21_cat1",6, xAxis1);
   h2clone__1->SetBinContent(1,38.96343);
   h2clone__1->SetBinContent(2,36.15475);
   h2clone__1->SetBinContent(3,47.98749);
   h2clone__1->SetBinContent(4,51.19731);
   h2clone__1->SetBinContent(5,51.432);
   h2clone__1->SetBinContent(6,53.45676);
   h2clone__1->SetEntries(1735);
   ...
   Graph_Graph_Graph12->SetMinimum(0.3896343);
   Graph_Graph_Graph12->SetMaximum(80.18515);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.09865205,0.08262566);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1413631,0.118403);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1654529,0.1385824);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.1743109,0.1460024);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1773215,0.1485244);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.1773211,0.1485251);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal21_cat1",6, xAxis2);
