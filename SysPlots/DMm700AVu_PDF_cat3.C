...
//=========  (Sat Jul 12 15:48:07 2014) by ROOT version5.34/11
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.409,0.4991851,1.291,73.23757);
   pad1->SetFillColor(0);
   ...
   grae->SetPoint(0,0.5375,49.91851);
   grae->SetPointError(0,0.03749999,0.03749999,0.5629768,0.5629768);
   grae->SetPoint(1,0.6125,37.06154);
   grae->SetPointError(1,0.03749999,0.03749999,1.945499,1.945499);
   grae->SetPoint(2,0.7,46.39066);
   grae->SetPointError(2,0.05000001,0.05000001,0.7682343,0.7682343);
   grae->SetPoint(3,0.8,46.17154);
   grae->SetPointError(3,0.05000001,0.05000001,2.055347,2.055347);
   grae->SetPoint(4,0.9,42.06592);
   grae->SetPointError(4,0.04999998,0.04999998,0.5909691,0.5909691);
   grae->SetPoint(5,1.075,43.97582);
   grae->SetPointError(5,0.125,0.125,0.7704315,0.7704315);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.4991851);
   Graph_Graph9->SetMaximum(65.96373);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal21_cat2",6, xAxis5);
   h2clone__5->SetBinContent(1,49.91851);
   h2clone__5->SetBinContent(2,37.06154);
   h2clone__5->SetBinContent(3,46.39066);
   h2clone__5->SetBinContent(4,46.17154);
   h2clone__5->SetBinContent(5,42.06592);
   h2clone__5->SetBinContent(6,43.97582);
   h2clone__5->SetEntries(1887);
   ...
   Graph_Graph_Graph910->SetMinimum(0.4991851);
   Graph_Graph_Graph910->SetMaximum(65.96373);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.01127792,0.01127792);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.05249375,0.05249375);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.01656011,0.01656011);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.04451546,0.04451546);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.01404864,0.01404864);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.01751944,0.01751944);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal21_cat2",6, xAxis6);
