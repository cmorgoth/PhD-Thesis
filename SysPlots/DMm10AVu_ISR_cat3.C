...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,5.484173,4.762371);
   grae->SetPoint(1,0.6125,28.09571);
   grae->SetPointError(1,0.03749999,0.03749999,5.427076,4.712778);
   grae->SetPoint(2,0.7,24.88662);
   grae->SetPointError(2,0.05000001,0.05000001,4.807205,4.174459);
   grae->SetPoint(3,0.8,22.96148);
   grae->SetPointError(3,0.05000001,0.05000001,4.435335,3.851528);
   grae->SetPoint(4,0.9,23.85752);
   grae->SetPointError(4,0.04999998,0.04999998,4.608414,4.00185);
   grae->SetPoint(5,1.075,20.31174);
   grae->SetPointError(5,0.125,0.125,3.923491,3.407085);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.2031174);
   Graph_Graph1->SetMaximum(37.32994);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal9_cat2",6, xAxis1);
   h2clone__1->SetBinContent(1,28.84039);
   h2clone__1->SetBinContent(2,28.09571);
   h2clone__1->SetBinContent(3,24.88662);
   h2clone__1->SetBinContent(4,22.96148);
   h2clone__1->SetBinContent(5,23.85752);
   h2clone__1->SetBinContent(6,20.31174);
   h2clone__1->SetEntries(1360);
   ...
   Graph_Graph_Graph12->SetMinimum(0.2031174);
   Graph_Graph_Graph12->SetMaximum(37.32994);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.190156,0.1651286);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.1931639,0.1677401);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.1931642,0.1677391);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.1931642,0.1677387);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.1931639,0.1677395);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.1931637,0.1677398);
   ...
   TH1F *h4clone__2 = new TH1F("h4clone__2","signal9_cat2",6, xAxis2);
