...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.05000001,0.05000001,4.201172,3.646772);
   grae->SetPoint(1,0.65,15.07168);
   grae->SetPointError(1,0.04999998,0.04999998,2.908716,2.524886);
   grae->SetPoint(2,0.825,26.40178);
   grae->SetPointError(2,0.125,0.125,5.095346,4.42296);
   grae->SetPoint(3,1.075,6.139977);
   grae->SetPointError(3,0.125,0.125,1.184969,1.028599);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,0.43,1.27);
   Graph_Graph1->SetMinimum(0.06139977);
   Graph_Graph1->SetMaximum(39.60267);
   ...
   TH1F *h2clone__1 = new TH1F("h2clone__1","signal11_cat3",4, xAxis1);
   h2clone__1->SetBinContent(1,21.76858);
   h2clone__1->SetBinContent(2,15.07168);
   h2clone__1->SetBinContent(3,26.40178);
   h2clone__1->SetBinContent(4,6.139977);
   h2clone__1->SetEntries(500);
   ...
   Graph_Graph_Graph12->SetMinimum(0.06139977);
   Graph_Graph_Graph12->SetMaximum(39.60267);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.05000001,0.05000001,0.1929925,0.1675246);
   grae->SetPoint(1,0.65,1);
   grae->SetPointError(1,0.04999998,0.04999998,0.1929922,0.1675252);
   grae->SetPoint(2,0.825,1);
   grae->SetPointError(2,0.125,0.125,0.1929925,0.1675251);
   grae->SetPoint(3,1.075,1);
   grae->SetPointError(3,0.125,0.125,0.1929924,0.1675248);
