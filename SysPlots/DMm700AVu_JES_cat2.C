...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.8096542,0.8999825);
   grae->SetPoint(1,0.6125,36.15475);
   grae->SetPointError(1,0.03749999,0.03749999,0.2076416,1.298649);
   grae->SetPoint(2,0.7,47.98749);
   grae->SetPointError(2,0.05000001,0.05000001,1.135502,0.3696671);
   grae->SetPoint(3,0.8,51.19731);
   grae->SetPointError(3,0.05000001,0.05000001,0.07083511,0.9989548);
   grae->SetPoint(4,0.9,51.432);
   grae->SetPointError(4,0.04999998,0.04999998,1.590332,0.5655937);
   grae->SetPoint(5,1.075,53.45676);
   grae->SetPointError(5,0.125,0.125,0.9061737,1.494263);
   
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.43,1.27);
   Graph_Graph5->SetMinimum(0.3896343);
   Graph_Graph5->SetMaximum(80.18515);
   ...
   TH1F *h2clone__3 = new TH1F("h2clone__3","signal21_cat1",6, xAxis3);
   h2clone__3->SetBinContent(1,38.96343);
   h2clone__3->SetBinContent(2,36.15475);
   h2clone__3->SetBinContent(3,47.98749);
   h2clone__3->SetBinContent(4,51.19731);
   h2clone__3->SetBinContent(5,51.432);
   h2clone__3->SetBinContent(6,53.45676);
   h2clone__3->SetEntries(1735);
   ...
   Graph_Graph_Graph56->SetMinimum(0.3896343);
   Graph_Graph_Graph56->SetMaximum(80.18515);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.02077985,0.02309813);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.005743134,0.03591917);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.02366246,0.007703405);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.001383571,0.01951186);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.03092106,0.01099692);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.01695153,0.02795273);
   ...
   TH1F *h4clone__4 = new TH1F("h4clone__4","signal21_cat1",6, xAxis4);
