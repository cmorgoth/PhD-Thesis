...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.8074741,0.8074741);
   grae->SetPoint(1,0.6125,28.09571);
   grae->SetPointError(1,0.03749999,0.03749999,1.056038,1.056038);
   grae->SetPoint(2,0.7,24.88662);
   grae->SetPointError(2,0.05000001,0.05000001,0.9748459,0.9748459);
   grae->SetPoint(3,0.8,22.96148);
   grae->SetPointError(3,0.05000001,0.05000001,0.5446644,0.5446644);
   grae->SetPoint(4,0.9,23.85752);
   grae->SetPointError(4,0.04999998,0.04999998,1.284101,1.284101);
   grae->SetPoint(5,1.075,20.31174);
   grae->SetPointError(5,0.125,0.125,1.372271,1.372271);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","",100,0.43,1.27);
   Graph_Graph9->SetMinimum(0.2031174);
   Graph_Graph9->SetMaximum(37.32994);
   ...
   TH1F *h2clone__5 = new TH1F("h2clone__5","signal9_cat2",6, xAxis5);
   h2clone__5->SetBinContent(1,28.84039);
   h2clone__5->SetBinContent(2,28.09571);
   h2clone__5->SetBinContent(3,24.88662);
   h2clone__5->SetBinContent(4,22.96148);
   h2clone__5->SetBinContent(5,23.85752);
   h2clone__5->SetBinContent(6,20.31174);
   h2clone__5->SetEntries(1360);
   ...
   Graph_Graph_Graph910->SetMinimum(0.2031174);
   Graph_Graph_Graph910->SetMaximum(37.32994);
...
// ------------>Primitives in pad: pad2
   ...
   grae->SetPointError(0,0.03749999,0.03749999,0.02799804,0.02799804);
   grae->SetPoint(1,0.6125,1);
   grae->SetPointError(1,0.03749999,0.03749999,0.03758715,0.03758715);
   grae->SetPoint(2,0.7,1);
   grae->SetPointError(2,0.05000001,0.05000001,0.03917148,0.03917148);
   grae->SetPoint(3,0.8,1);
   grae->SetPointError(3,0.05000001,0.05000001,0.02372079,0.02372079);
   grae->SetPoint(4,0.9,1);
   grae->SetPointError(4,0.04999998,0.04999998,0.05382375,0.05382375);
   grae->SetPoint(5,1.075,1);
   grae->SetPointError(5,0.125,0.125,0.06756048,0.06756048);
   ...
   TH1F *h4clone__6 = new TH1F("h4clone__6","signal9_cat2",6, xAxis6);
