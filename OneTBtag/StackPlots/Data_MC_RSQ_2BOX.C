...
// ------------>Primitives in pad: pad1
   ...
   R2_1D_5mu_Box->SetBinContent(1,2.584317);
   R2_1D_5mu_Box->SetBinContent(2,2.155098);
   R2_1D_5mu_Box->SetBinContent(3,1.726995);
   R2_1D_5mu_Box->SetBinContent(4,1.406077);
   R2_1D_5mu_Box->SetBinContent(5,0.652284);
   R2_1D_5mu_Box->SetBinContent(6,0.4748896);
   R2_1D_5mu_Box->SetBinContent(7,0.2520039);
   R2_1D_5mu_Box->SetBinContent(8,0.07266217);
   R2_1D_5mu_Box->SetBinContent(9,0.05859477);
   R2_1D_5mu_Box->SetEntries(224);
   ...
   TH1F *R2_1D_5mu_Box = new TH1F("R2_1D_5mu_Box","",20,0.5,2);
   R2_1D_5mu_Box->SetBinContent(1,4.641132);
   R2_1D_5mu_Box->SetBinContent(2,4.097773);
   R2_1D_5mu_Box->SetBinContent(3,3.04088);
   R2_1D_5mu_Box->SetBinContent(4,2.784065);
   R2_1D_5mu_Box->SetBinContent(5,2.156078);
   R2_1D_5mu_Box->SetBinContent(6,1.763048);
   R2_1D_5mu_Box->SetBinContent(7,0.8956517);
   R2_1D_5mu_Box->SetBinContent(8,0.7228608);
   R2_1D_5mu_Box->SetBinContent(9,0.1396515);
   R2_1D_5mu_Box->SetBinContent(12,0.02730041);
   R2_1D_5mu_Box->SetEntries(524);
   R2_1D_5mu_Box->SetStats(0);
   ...
   R2_1D_Data_2mu_Box->SetBinContent(1,9);
   R2_1D_Data_2mu_Box->SetBinContent(2,7);
   R2_1D_Data_2mu_Box->SetBinContent(3,3);
   R2_1D_Data_2mu_Box->SetBinContent(4,6);
   R2_1D_Data_2mu_Box->SetBinContent(5,4);
   R2_1D_Data_2mu_Box->SetBinContent(6,4);
   R2_1D_Data_2mu_Box->SetBinContent(9,1);
   R2_1D_Data_2mu_Box->SetBinError(1,3);
   R2_1D_Data_2mu_Box->SetBinError(2,2.645751);
   R2_1D_Data_2mu_Box->SetBinError(3,1.732051);
   R2_1D_Data_2mu_Box->SetBinError(4,2.44949);
   R2_1D_Data_2mu_Box->SetBinError(5,2);
   R2_1D_Data_2mu_Box->SetBinError(6,2);
   R2_1D_Data_2mu_Box->SetBinError(9,1);
   R2_1D_Data_2mu_Box->SetEntries(34);
...
// ------------>Primitives in pad: pad2
   ...
   RATIO->SetBinContent(1,1.245597);
   RATIO->SetBinContent(2,1.119486);
   RATIO->SetBinContent(3,0.6292112);
   RATIO->SetBinContent(4,1.431932);
   RATIO->SetBinContent(5,1.424318);
   RATIO->SetBinContent(6,1.78736);
   RATIO->SetBinContent(9,5.044231);
   RATIO->SetBinError(1,0.4287046);
   RATIO->SetBinError(2,0.4360872);
   RATIO->SetBinError(3,0.3704009);
   RATIO->SetBinError(4,0.607435);
   RATIO->SetBinError(5,0.7402748);
   RATIO->SetBinError(6,0.9397092);
   RATIO->SetBinError(9,5.439611);
   RATIO->SetMinimum(0);
   RATIO->SetMaximum(3.05);
   RATIO->SetEntries(5.041809);
   RATIO->SetStats(0);
