...
//=========  (Thu Sep 10 11:45:21 2015) by ROOT version6.03/03
   ...
   f1->SetParameter(0,852.6474);
   f1->SetParError(0,8.020093);
   f1->SetParLimits(0,0,0);
   f1->SetParameter(1,0.00379103);
   f1->SetParError(1,0.007266712);
   f1->SetParLimits(1,0,0);
   f1->SetParameter(2,1.7);
   f1->SetParError(2,0);
   f1->SetParLimits(2,1.7,1.7);
   f1->SetParameter(3,0.5476179);
   f1->SetParError(3,0.008677862);
   ...
   histo__1->Draw("");
   TLatex *   tex = new TLatex(0.93,0.88,"#sigma = 0.55 #pm 0.01 [mm]");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
